...
async fn listen_blocks(mut stream: mpsc::Receiver<near_indexer::StreamerMessage>) {
    while let Some(streamer_message) = stream.recv().await {
        ...
        //
        // Note that `outcomes` for a given transaction won't be included into the same
        // block. Execution outcomes are included into the blocks after the
        // transaction or receipt are recorded on a chain; in most cases, it is
        // the next block after the one that has the transaction or receipt.
        //
        // StreamerMessage {
        //     block: BlockView {
        //         author: "test.near",
        ...
        //             last_ds_final_block:
        // `2vJNJca72pBiq2eETq2xvuoc6caKDaUkdRgtdefyutbA`,             
        // next_bp_hash: `4DJWnxRbUhRrsXK6EBkx4nFeXHKgJWqteDnJ7Hv4MZ6M`,
        //             block_merkle_root:
        // `Bvn5K89fJ3uPNsj3324Ls9TXAGUVteHPpfKwKqL1La6W`,             
        // approvals: [                 Some(
        //                     
        ...
        //             ],
        //             signature:
        // ed25519:239NbE4BuJaxneQA3AEsPrsGY7v3wBgaezbgg56HER69zPrBoc3a4fbyVWPXeoKE3LvgGma1g6pSHk9QHkmETCZY,
        ...
        // encoded_length: 8,                 height_created: 63596,
        ...
        // validator_proposals: [],                 signature:
        // ed25519:2vWNayBzEoW5DRc7gTdhxdLbkKuK6ACQ78p3JGpKSAZZCarnLroeoALPAFwpr9ZNPxBqdVYh9QLBe7WHZebsS17Z,
        //             },
        //         ],
        //     },
        //     shards: [
        ...
        //                         chunk_hash:
        // `2M2oeNFBbUUnHfkU1UuBr8EKBCLMH9xr2vfsGRpyiBmA`,                      
        // prev_block_hash: `2vJNJca72pBiq2eETq2xvuoc6caKDaUkdRgtdefyutbA`,
        //                         outcome_root: `11111111111111111111111111111111`,
        //                         prev_state_root:
        // `3gZPPijaumgMRCvMuuZZM1Ab2LoHTSfYigMKwLqZ67m6`,                      
        ...
        //                                 signer_id: "test.near",
        //                                 public_key:
        // ed25519:8NA7mh6TAWzy2qz68bHp62QHTEQ6nJLfiYeKDRwEbU3X,                
        // nonce: 1,                                 receiver_id:
        // "some.test.near",                                 actions: [
        //                                     CreateAccount,
        //                                     Transfer {
        ...
        //                                     AddKey {
        //                                         public_key:
        // ed25519:2syGhqwJ8ba2nUGmP9tkZn9m1DYZPYYobpufiERVnug8,                
        ...
        //                                 ],
        //                                 signature:
        // ed25519:Qniuu7exnr6xbe6gKafV5vDhuwM1jt9Bn7sCTF6cHfPpYWVJ4Q6kq8RAxKSeLoxbCreVp1XzMMJmXt8YcUqmMYw,
        //                                 hash:
        // `8dNv9S8rAFwso9fLwfDQXmw5yv5zscDjQpta96pMF6Bi`,                      
        // },                             outcome:
        // IndexerExecutionOutcomeWithReceipt {                                 
        // execution_outcome: ExecutionOutcomeWithIdView {                      
        // proof: [],                                     block_hash:
        // `G9v6Fsv94xaa7BRY2N5PFF5PJwT7ec6DPzQK73Yf3CZ6`,                      
        ...
        //                                         status:
        // SuccessReceiptId(CbWu7WYYbYbn3kThs5gcxANrxy7AKLcMcBLxLw8Zq1Fz),
        //                                     },
        //                                 },
        //                                 receipt: None,
        //                             },
        ...
        //                             receipt_id:
        // `CbWu7WYYbYbn3kThs5gcxANrxy7AKLcMcBLxLw8Zq1Fz`,                      
        // receipt: Action {                                 signer_id:
        // "test.near",                                 signer_public_key:
        // ed25519:8NA7mh6TAWzy2qz68bHp62QHTEQ6nJLfiYeKDRwEbU3X,                
        // gas_price: 1030000000,                                 
        // output_data_receivers: [],                                 
        // input_data_ids: [],                                 actions: [
        //                                     CreateAccount,
        //                                     Transfer {
        //                                         deposit: 40000000000000000000000000,
        //                                     },
        ...
        //                         proof: [],
        //                         block_hash:
        // `BXPB6DQGmBrjARvcgYwS8qKLkyto6dk9NfawGSmfjE9Q`,                      
        // id: `CbWu7WYYbYbn3kThs5gcxANrxy7AKLcMcBLxLw8Zq1Fz`,                  
        // outcome: ExecutionOutcomeView {                             logs: [],
        //                             receipt_ids: [
        ...
        //                         receipt_id:
        // `CbWu7WYYbYbn3kThs5gcxANrxy7AKLcMcBLxLw8Zq1Fz`,                      
        // receipt: Action {                             signer_id: "test.near",
        //                             signer_public_key:
        // ed25519:8NA7mh6TAWzy2qz68bHp62QHTEQ6nJLfiYeKDRwEbU3X,                
        // gas_price: 1030000000,                             
        // output_data_receivers: [],                             
