...
use near_chain::resharding::trie_state_resharder::{self, TrieStateResharder};
...
pub(crate) fn resume_resharding(
    ...
    tracing::info!(target: "resharding", "flat storage completed");
    ...
    tracing::info!(target: "resharding", "trie state completed");
