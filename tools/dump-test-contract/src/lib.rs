...
use near_test_contracts::{
    backwards_compatible_rs_contract, compact_test_contract, estimator_contract, ft_contract,
    fuzzing_contract, nightly_rs_contract, rs_contract, smallest_rs_contract, trivial_contract,
    ts_contract,
};
use std::io::Write;
...
impl DumpTestContractCommand {
    pub fn run(&self) -> anyhow::Result<()> {
        ...
        let code = match &*name {
            ...
            "compact_test_contract" => compact_test_contract(),
