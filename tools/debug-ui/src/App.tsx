  ...
  return (
    <div className="App">
      ...
      <div className="navbar">
        <NavLink to="last_blocks" className={navLinkClassName}>Latest Blocks</NavLink>
        <NavLink to="network_info" className={navLinkClassName}>Network Info</NavLink>
        <NavLink to="epoch_info" className={navLinkClassName}>Epoch Info</NavLink>
        <NavLink to="chain_and_chunk_info" className={navLinkClassName}>Chain & Chunk Info</NavLink>
