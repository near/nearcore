...
release:
	cargo $(RUST_OPTIONS) build -p neard --release --features performance_stats
...
debug:
	cargo $(RUST_OPTIONS) build -p neard --features performance_stats
...
nightly-release:
	cargo $(RUST_OPTIONS) build -p neard --release --features nightly_protocol --features nightly_protocol_features -- features performance_stats
...
nightly-debug:
	cargo $(RUST_OPTIONS) build -p neard --features nightly_protocol --features nightly_protocol_features --features performance_stats
