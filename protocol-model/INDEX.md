...
Entry point for the implementation-derived NEAR protocol model (version **86**,
commit `f0c7706f`). Each component has a reusable generation plan in `plans/` and a
spec in `spec/`. ✅ = written + verified, ⬜ = planned (not yet written).
