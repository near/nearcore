...
| `EarlyKickout` | **v87** | Pre-computes/persists chunk-producer assignments in `DBCol::ChunkProducers` for early kickout. Not active at v86; stabilized at v87, after this model's pinned snapshot. |
