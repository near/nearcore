...
| `EarlyKickout` | `version.rs:401` | 87 (152 nightly on this pinned tree) | Rollout switch for `VersionedPartialEncodedStateWitness` V1→V2 (V2 adds `prev_block_hash` for hash-based chunk-producer lookup). **Inert at v86**: `new` always emits V1 and handlers drop V2 (`partial_witness.rs:269`, `partial_witness_actor.rs:415`/`:514`). |
...
| `core/primitives-core/src/version.rs:401` | `EarlyKickout` | Nightly @ 152 on this pinned tree, stabilized @ 87; gates witness V2. |
