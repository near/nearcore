mod tests {
    ...
    use testlib::client_test_utils::{setup_mock_all_validators, TestEnv};
    ...
    fn test_request_chunk_restart() {
        ...
        if let NetworkRequests::PartialEncodedChunkResponse { response: response_body, .. } =
            response
        {
    ...
    fn update_chunk_hash(
        chunk: PartialEncodedChunkV2,
        new_hash: ChunkHash,
