#![cfg(feature = "test_features")] // required for adversarial behaviours
//! Test behaviours of the network when the chunk producer is malicious or misbehaving.
...
fn test_producer_with_expired_transactions() {
    ...
    // than the transactiosn are valid for.
