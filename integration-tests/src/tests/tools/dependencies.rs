...
const LIBS_THRESHOLDS: [(&str, usize); 9] = [
    ("near-primitives", 258),
    ("near-jsonrpc-primitives", 260),
    ("near-chain-configs", 259),
    ("near-chain-primitives", 259),
    ("near-client-primitives", 270),
    ("near-parameters", 67),
    ("near-crypto", 75),
...
fn get_and_assert_crate_dependencies(name: &str, threshold: usize) -> usize {
    ...
    //   │   ├── my_crate v0.6.0 (proc-macro)
    // This line indicates that the crate `my_crate` version `0.6.0` is a dependency.
    //
