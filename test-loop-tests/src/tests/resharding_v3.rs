...
fn test_resharding_v3_base(params: TestReshardingParameters) {
    ...
    if params.limit_outgoing_gas || params.short_yield_timeout {
        ...
        if params.limit_outgoing_gas {
            runtime_config.congestion_control_config.max_outgoing_gas = Gas::from_tera(100);
            runtime_config.congestion_control_config.min_outgoing_gas = Gas::from_tera(100);
        }
