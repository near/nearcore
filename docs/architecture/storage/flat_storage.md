...
creation. That’s why FlatStateFactory has set_flat_storage_for_genesis method which is called 
...
should call RuntimeAdapter.get_flat_storage_for_shard → FlatStorageState.update_flat_head.
