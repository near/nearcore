...
set of genesis records that can be used to start your own test chain,
...
you'd like to spoon. So if we want to use mainnet state, you can
...
the accounts that you have access to in mainnet. If you want to add an
