...
bumped to the next protocol version. Instead a process calls voting takes place and determines if and 
...
and configured by the neard release owner e.g. [like this](https://github.com/near/nearcore/commit/9b0275de057a01f87c259580f93e58f746da75aa). 
