...
# Run nearlib tests
rm -rf nearlib
git clone --single-branch --branch staging https://github.com/nearprotocol/nearlib.git nearlib
cd nearlib
...
git clone --single-branch --branch staging https://git@github.com/nearprotocol/near-shell.git near-shell
cd near-shell
yarn
#yarn test
cd ..
