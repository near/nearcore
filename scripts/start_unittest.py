...
if __name__ == "__main__":
    ...
    parser.add_argument('--debug', action='store_true', help='If set, compiles nearcore in release mode')
    parser.add_argument(
    ...
    print(args.debug)
    setup_and_run(args.local, args.debug, args.image, 'testdir', ['--chain-id=', '--test-seed=alice.near', '--account-id=test.near', '--fast'], '')
