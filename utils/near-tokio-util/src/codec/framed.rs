...
impl<T, U> ProjectFuse for Fuse<T, U> {
    ...
    fn project(self: Pin<&mut Self>) -> Fuse<Pin<&mut Self::Io>, &mut Self::Codec> {
        ...
        Fuse { io: self_.io, codec: self_.codec }
    }
}
    ...
    U: Decoder + Encoder,
{
    ...
    pub fn new(inner: T, codec: U) -> Framed<T, U> {
        Framed { inner: framed_read2(framed_write2(Fuse { io: inner, codec })) }
    }
}
...
impl<T, U> Framed<T, U> {
        ...
        Framed {
            inner: framed_read2_with_buffer(
                framed_write2_with_buffer(
                    Fuse { io: parts.io, codec: parts.codec },
                    parts.write_buf,
                ),
                parts.read_buf,
            ),
    ...
    pub fn into_parts(self) -> FramedParts<T, U> {
        ...
        FramedParts { io: inner.io, codec: inner.codec, read_buf, write_buf, _priv: () }
    }
}
