...
use crate::codec::{Decoder, Encoder, Framed, FramedWrite, NearFramedRead};
...
impl Builder {
    ...
    /// # pub fn main() {}
    /// ```
    pub fn new_read<T>(&self, upstream: T) -> NearFramedRead<T, LengthDelimitedCodec>
    where
        T: AsyncRead,
    {
        NearFramedRead::new(upstream, self.new_codec())
    }
