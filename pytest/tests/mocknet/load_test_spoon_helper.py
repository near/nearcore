...
# Keep track of how many times the state was set and whether the last call was to set state.
function_call_state = {}
...
def random_transaction(account, i, node_account_id, max_tps_per_node):
...
def throttle_txns(send_txns, total_tx_sent, elapsed_time, max_tps_per_node,
    ...
    send_txns(node_account_id, test_accounts, max_tps_per_node)
...
def get_test_accounts_from_args():
    ...
    return (node_account_id, accounts, max_tps_per_node)
