...
# Must be >= 4 * EPOCH_LENGTH for epoch sync proof derivation under SyncV2.
TARGET_HEIGHT2 = EPOCH_LENGTH * 4 + (EPOCH_LENGTH // 2)
...
nodes[1].start_with_epoch_sync_restart(boot_node=nodes[0])
