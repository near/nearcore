...
nodes = start_cluster(2, 1, 8, None, [["num_block_producers", 199], ["block_producers_per_shard", [24, 25, 25, 25, 25, 25, 25, 25]], ["gas_price", 0], ["max_inflation_rate", 0], ["epoch_length", 10], ["block_producer_kickout_threshold", 70]], {})
nodes[1].kill()
