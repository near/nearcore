...
def is_tag_active(environment, tag):
    run_all = environment.parsed_options.tags is None and environment.parsed_options.exclude_tags is None
    opt_in = environment.parsed_options.tags is not None and tag in environment.parsed_options.tags
    not_excluded = environment.parsed_options.tags is None and not tag in environment.parsed_options.exclude_tags
