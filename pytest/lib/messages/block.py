...
class BlockHeader:
    ...
    def inner_lite(self):
        if self.enum == 'BlockHeaderV6':
            return self.BlockHeaderV6.inner_lite
        elif self.enum == 'BlockHeaderV5':
    ...
    [
        BlockHeaderV6, {
            ...
            'fields': [
                ['prev_hash', [32]],
                ['inner_lite', BlockHeaderInnerLite],
                ['inner_rest', BlockHeaderInnerRestV6],
                ['signature', Signature],
            ]
        }
    ],
