...
def create_genesis_file(nodes, genesis_template_filename, mocknet_genesis_file):
    ...
    genesis_config["num_block_producer_seats_per_shard"] = [len(nodes)]*8
    genesis_config["avg_hidden_validator_seats_per_shard"] = [0]*8
    genesis_config["shard_layout"]["V0"]["num_shards"] = 8
    genesis_config["simple_nightshade_shard_config"] = {}
    genesis_config["simple_nightshade_shard_config"]["num_block_producer_seats_per_shard"] = [len(nodes)]*8
    genesis_config["simple_nightshade_shard_config"]["avg_hidden_validator_seats_per_shard"] = [0]*8
    genesis_config["simple_nightshade_shard_config"]["shard_layout"] = {}
    genesis_config["simple_nightshade_shard_config"]["shard_layout"]["V0"] = {}
    genesis_config["simple_nightshade_shard_config"]["shard_layout"]["V0"]["num_shards"] = 8
...
def update_config_file(nodes):
    ...
    config_json["tracked_shards"] = list(range(0,8))
