...
for shard_id in {0..3}; do
  objects_shard=$(aws s3 ls s3://state-parts-xiangyi/multi_node_tmp_1/chain_id=testnet/epoch_height=1927/epoch_id=CmAnEioj5WR3V9DbngdmreiE51U3jB5WfHx5ETTAZBDJ/shard_id=$shard_id/ | sort -k1,2)
