...
pub fn get_random_receipt_size_for_test(rng: &mut dyn RngCore) -> u64 {
...
pub trait ReceiptSizeGenerator: std::fmt::Debug {
    fn generate_receipt_size(&mut self, rng: &mut dyn RngCore) -> ByteSize;
}
...
impl ReceiptSizeGenerator for MaxReceiptSizeGenerator {
    fn generate_receipt_size(&mut self, _rng: &mut dyn RngCore) -> ByteSize {
