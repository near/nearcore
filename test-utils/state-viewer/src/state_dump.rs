...
pub fn state_dump(
    ...
    for (shard_id, state_root) in state_roots.iter().enumerate() {
        let trie = runtime.get_trie_for_shard(shard_id as u64, last_block_header.prev_hash());
    ...
    genesis_config.shard_layout = runtime.get_shard_layout(last_block_header.epoch_id());
