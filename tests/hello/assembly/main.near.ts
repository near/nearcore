...
import {context as context,storage as storage,ContractPromise as ContractPromise,ContractPromiseResult as ContractPromiseResult,near as near} from "./near";
...
export function setKeyValue(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function getValueByKey(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function getAllKeys(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function benchmark_storage(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function benchmark_sum_n(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function returnHiWithLogs(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function testSetRemove(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
...
export function getLastResult(): void {
      // Reading input bytes.
      let json = storage._internalReadBytes(4, 0, 0);
