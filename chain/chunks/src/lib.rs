...
impl ShardsManager {
    ...
    // We want to sample some parts that depend on prev_block_hash, and local_random_seed
    fn should_sample_part(&self, prev_block_hash: &CryptoHash, part_ord: u64) -> Result<bool, Error> {
