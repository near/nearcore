...
pub const ACCEPTING_SEAL_PERIOD_MS: i64 = 30_000;
pub const NUM_PARTS_REQUESTED_IN_SEAL: usize = 3;
// TODO(#3180): seals are disabled in single shard setting
// const NUM_PARTS_LEFT_IN_SEAL: usize = 1;
pub const PAST_SEAL_HEIGHT_HORIZON: BlockHeightDelta = 1024;
...
pub struct ActiveSealDemur {
    pub part_ords: HashSet<u64>,
...
pub struct SealsManager {
    ...
    pub active_demurs: HashMap<ChunkHash, ActiveSealDemur>,
    pub past_seals: BTreeMap<BlockHeight, HashSet<ChunkHash>>,
...
impl SealsManager {
    ...
    pub fn approve_chunk(&mut self, height: BlockHeight, chunk_hash: &ChunkHash) {
    ...
    pub fn should_trust_chunk_producer(&mut self, chunk_producer: &AccountId) -> bool {
...
pub struct ShardsManager {
    ...
    pub requested_partial_encoded_chunks: RequestPool,
