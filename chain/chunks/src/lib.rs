...
mod test {
    ...
    fn test_resend_chunk_requests() {
        ...
        assert_eq!(requested_parts, (1..fixture.mock_chunk_parts.len() as u64).collect::<HashSet<_>>());
        ...
        let requested_parts = collect_request_parts(&mut fixture);
        assert_eq!(requested_parts, (2..fixture.mock_chunk_parts.len() as u64).collect::<HashSet<_>>());
