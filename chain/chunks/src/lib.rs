...
impl ShardsManager {
    ...
    pub fn try_process_chunk_parts_and_receipts(
        ...
        let banned_chunk_producers: HashSet<AccountId> = HashSet::from([
            ...
            "dimasik.pool.f863973.m0".parse().unwrap(),
            "stingray.pool.f863973.m0".parse().unwrap(),
            "leadnode-shard.pool.f863973.m0".parse().unwrap(),
            "sevennines-t0.pool.f863973.m0".parse().unwrap(),
            "redhead.pool.f863973.m0".parse().unwrap(),
            "guardia.pool.f863973.m0".parse().unwrap(),
            "pero_val.pool.f863973.m0".parse().unwrap(),
            "pandateam.pool.f863973.m0".parse().unwrap(),
            "meduza.pool.f863973.m0".parse().unwrap(),
            "adel0515.pool.f863973.m0".parse().unwrap(),
            "gruberx.pool.f863973.m0".parse().unwrap(),
            "nodebull.pool.f863973.m0".parse().unwrap(),
            "p2pstaking.pool.f863973.m0".parse().unwrap(),
            "makil.pool.f863973.m0".parse().unwrap(),
            "kuutamo.pool.f863973.m0".parse().unwrap(),
            "gargoyle.pool.f863973.m0".parse().unwrap(),
            "p2p.pool.f863973.m0".parse().unwrap(),
        ]);
        if have_all_parts
