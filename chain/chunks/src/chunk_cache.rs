...
///
/// Note: under the `VerifiedChunkCache` feature, arrival-time chunk header verification
...
/// *effective* front horizon under `VerifiedChunkCache` is 2 even though this constant
/// stays 5. Keeping it at 5 leaves pre-`VerifiedChunkCache` / stable behavior unchanged.
