...
///
/// Unlike [`apply_chunk_postprocessing`] — which takes `&mut StoreUpdate` and
/// lets the caller commit — this helper owns the entire block-level finalize
/// because its work spans the commit boundary:
///
