...
impl ChainStore {
    ...
    fn collect_state_transition_data(
        ...
        tracing::debug!(target: "incident", "collect_state_transition_data loop done");
        ...
        tracing::debug!(target: "incident", "collect_state_transition_data get_state_transition done");
    ...
    fn collect_source_receipt_proofs(
        ...
        tracing::debug!(target: "incident", "collect_source_receipt_proofs find first loop start");
        ...
        tracing::debug!(target: "incident", "collect_source_receipt_proofs find first loop end");
        ...
        tracing::debug!(target: "incident", "collect_source_receipt_proofs get_incoming_receipts_for_shard start");
        ...
        tracing::debug!(target: "incident", "collect_source_receipt_proofs get_incoming_receipts_for_shard end");

        tracing::debug!(target: "incident", "collect_source_receipt_proofs convert loop start");
        ...
        tracing::debug!(target: "incident", "collect_source_receipt_proofs convert loop end");
