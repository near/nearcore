...
fn build_chain() {
    ...
    if cfg!(feature = "nightly") {
        ...
        insta::assert_snapshot!(hash, @"CS9KdX9mtW7MaSqdEWAzLtstPSe7GNYRnHjghSNpurja");
    } else {
        // cspell:disable-next-line
        insta::assert_snapshot!(hash, @"FAVNR4CAeaMgUAT1MMnpm9UhgQKJF6zTtwHPQFWF8pS6");
    }
    ...
    if cfg!(feature = "nightly") {
        // cspell:disable-next-line
        insta::assert_snapshot!(hash, @"5x3zDxKrrLGBrdhqTfo2ydvhFQ677H98fEnpHg7UcvW6");
    } else {
        // cspell:disable-next-line
        insta::assert_snapshot!(hash, @"AD6NwoqPiW752GYHAMiPQdiifK32iobeVNniJooDYS4r");
    }
}
