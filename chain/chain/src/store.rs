...
pub struct ChainStore {
    ...
    /// Cache with blocks.
    pub blocks: SizedCache<Vec<u8>, Block>,
    /// Cache with chunks
    ...
    pub height: SizedCache<Vec<u8>, CryptoHash>,
    /// Cache with height to block hash on any chain.
    pub block_hash_per_height: SizedCache<Vec<u8>, HashMap<EpochId, HashSet<CryptoHash>>>,
...
pub struct ChainStoreCacheUpdate {
    pub blocks: HashMap<CryptoHash, Block>,
    ...
    pub height_to_hashes: HashMap<BlockHeight, Option<CryptoHash>>,
...
pub struct ChainStoreUpdate<'a> {
    ...
    pub chain_store_cache_update: ChainStoreCacheUpdate,
    head: Option<Tip>,
    tail: Option<BlockHeight>,
...
impl<'a> ChainStoreUpdate<'a> {
    ...
    pub fn update_height_if_not_challenged(
        &mut self,
        height: BlockHeight,
        hash: CryptoHash,
    ) -> Result<(), Error> {
