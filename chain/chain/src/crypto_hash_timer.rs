...
static CRYPTO_HASH_TIMER_RESULTS: std::sync::LazyLock<Mutex<LruCache<CryptoHash, Duration>>> =
    std::sync::LazyLock::new(|| Mutex::new(LruCache::new(NonZeroUsize::new(10000).unwrap())));
