...
// TODO(#chunk_producer_lookups): migrate to get_chunk_producer_info_db
...
/// Uses get_chunk_producer_info(prev_block_hash, shard_id) which reads from
/// the ChunkProducers DB column when EarlyKickout is enabled.
