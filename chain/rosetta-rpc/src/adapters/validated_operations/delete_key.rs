...
pub(crate) struct DeleteKeyOperation {
    pub(crate) account: crate::models::AccountIdentifier,
    pub(crate) public_key: crate::models::PublicKey,
}

impl ValidatedOperation for DeleteKeyOperation {
    const OPERATION_TYPE: crate::models::OperationType = crate::models::OperationType::DeleteKey;
...
fn required_fields_error() -> crate::errors::ErrorKind {
    crate::errors::ErrorKind::InvalidInput(
        "DELETE_KEY operation requires `public_key` being passed in the metadata".into(),
    )
}

impl std::convert::TryFrom<crate::models::Operation> for DeleteKeyOperation {
