...
#[derive(
    Debug, Clone, PartialEq, Eq, Default, serde::Serialize, serde::Deserialize, ToSchema,
)]
...
#[derive(
    Debug, Clone, PartialEq, PartialOrd, ToSchema, serde::Serialize, serde::Deserialize,
)]
