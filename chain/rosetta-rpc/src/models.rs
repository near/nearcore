...
impl axum::response::IntoResponse for Error {
    fn into_response(self) -> axum::response::Response {
        ...
        (axum::http::StatusCode::INTERNAL_SERVER_ERROR, json).into_response()
    }
}
...
#[derive(Debug, Copy, Clone, PartialEq, serde::Serialize, serde::Deserialize, utoipa::ToSchema)]
...
#[derive(
    Debug, Clone, PartialEq, PartialOrd, utoipa::ToSchema, serde::Serialize, serde::Deserialize,
)]
...
#[derive(Debug, Clone, Eq, PartialEq, serde::Serialize, serde::Deserialize, utoipa::ToSchema)]
