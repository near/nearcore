...
pub fn epoch_info(
    ...
    block_producers_assignment: Vec<ValidatorId>,
    chunk_producers_assignment: Vec<Vec<ValidatorId>>,
    hidden_validators_assignment: Vec<ValidatorWeight>,
