...
3. We prefix new APIs with `EXPERIMENTAL_` (see the Experimental API Policies
   below).
4. We document the API change on [NEAR Docs](https://docs.near.org/docs/api/rpc)
...
Either way, we need to document the new API
[on the Experimental Methods documentation](https://docs.near.org/docs/api/rpc-experimental).
