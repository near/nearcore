...
pub(crate) static RPC_PROCESSING_TIME: LazyLock<HistogramVec> = LazyLock::new(|| {
...
pub(crate) static RPC_TIMEOUT_TOTAL: LazyLock<IntCounter> = LazyLock::new(|| {
...
pub(crate) static PROMETHEUS_REQUEST_COUNT: LazyLock<IntCounter> = LazyLock::new(|| {
    near_o11y::metrics::try_create_int_counter(
...
pub(crate) static HTTP_RPC_REQUEST_COUNT: LazyLock<IntCounterVec> = LazyLock::new(|| {
...
pub(crate) static HTTP_STATUS_REQUEST_COUNT: LazyLock<IntCounter> = LazyLock::new(|| {
    near_o11y::metrics::try_create_int_counter(
...
pub(crate) static RPC_ERROR_COUNT: LazyLock<IntCounterVec> = LazyLock::new(|| {
    near_o11y::metrics::try_create_int_counter_vec(
...
pub(crate) static RPC_UNREACHABLE_ERROR_COUNT: LazyLock<IntCounterVec> = LazyLock::new(|| {
    near_o11y::metrics::try_create_int_counter_vec(
