...
impl Actor for ClientActor {
    ...
    fn started(&mut self, ctx: &mut Self::Context) {
        // Start syncing job.
        // self.start_sync(ctx); // TODO: Fix me
...
impl Handler<NetworkClientMessages> for ClientActor {
    ...
    fn handle(&mut self, msg: NetworkClientMessages, ctx: &mut Context<Self>) -> Self::Result {
        ...
        match msg {
            NetworkClientMessages::CheckSendAnnounceAccount(prev_block_hash) => {
                self.check_send_announce_account(prev_block_hash);
            ...
            NetworkClientMessages::StateResponse(state_response_info) => {
                self.state_sync_addr
                    .do_send(StateSyncActorRequests::StateResponse(state_response_info));
                NetworkClientResponses::NoResponse
            }
