...
impl ClientActor {
    ...
    fn process_tx(&mut self, tx: SignedTransaction) -> NetworkClientResponses {
        ...
        let tx_header = unwrap_or_return!(self.client.chain.get_block_header(&tx.transaction.block_hash),
        ...
        match self.client.runtime_adapter.validate_tx(head.height + 1, tx_header.inner.timestamp, gas_price, state_root, tx) {
