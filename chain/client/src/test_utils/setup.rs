...
///                 and introducing severe fork fulness if `block_prod_time` is sufficiently small),
...
///                   waiting for 2/3. This allows for more fork fulness. `cross_shard_tx` has modes
