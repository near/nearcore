...
use crate::rpc_handler::ChunkEndorsementHandler;
...
pub fn client_sender_for_network(
    ...
    ClientSenderForNetwork {
        ...
        transaction: rpc_handler.into_sender(),
        announce_account: view_client_addr.into_sender(),
        chunk_endorsement: chunk_endorsement_handler.clone().into_sender(),
        spice_chunk_endorsement: chunk_endorsement_handler.into_sender(),
