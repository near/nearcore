...
fn test_verify_chunk_invalid_state_challenge() {
    ...
    };
    {
        ...
        assert_eq!(
            ...
            vec![
                vec![
                    1, 5, 0, 103, 144, 199, 219, 15, 108, 46, 61, 102, 241, 211, 217, 1, 164, 42,
                    135, 159, 146, 111, 179, 135, 231, 104, 192, 141, 105, 187, 208, 61, 25, 23,
                    100, 171, 30, 7, 228, 175, 99, 17, 113, 5, 94, 136, 200, 39, 136, 37, 110, 166,
                    241, 148, 128, 55, 131, 173, 97, 98, 201, 68, 82, 244, 223, 70, 86, 164, 5, 0,
                    0, 0, 0, 0, 0
                ],
                vec![
                    3, 1, 0, 0, 0, 16, 83, 80, 121, 35, 26, 179, 7, 144, 1, 31, 14, 73, 99, 192,
                    233, 83, 160, 154, 149, 53, 71, 79, 45, 205, 110, 53, 194, 44, 13, 155, 67, 0,
                    216, 5, 0, 0, 0, 0, 0, 0
                ]
            ],
        );
