    ...
    fn test_catchup_receipts_sync_common(wait_till: u64, send: u64, sync_hold: bool) {
        ...
        System::builder()
            ...
            .run(move || {
                ...
                let seen_heights_with_receipts =
                    Arc::new(RwLock::new(HashSet::<BlockHeight>::new()));
                ...
                let (_, conn, _) = setup_mock_all_validators(
                    ...
                    Arc::new(RwLock::new(Box::new(
                        move |_account_id: String, msg: &NetworkRequests| {
                            ...
                            let mut seen_hashes_with_state =
                                seen_hashes_with_state.write().unwrap();
                            match *phase {
        ...
        System::builder()
            ...
            .run(move || {
                ...
                let (_, conn, _) = setup_mock_all_validators(
                    ...
                    Arc::new(RwLock::new(Box::new(
                        move |_account_id: String, msg: &NetworkRequests| {
                            let mut seen_heights_same_block =
                                seen_heights_same_block.write().unwrap();
                            let mut phase = phase.write().unwrap();
                            match *phase {
    ...
    fn test_catchup_sanity_blocks_produced() {
        ...
        System::builder()
            ...
            .run(move || {
                ...
                let check_height = move |hash: CryptoHash, height| match heights1
                    .write()
                    .unwrap()
                    .entry(hash.clone())
                {
    ...
    fn test_all_chunks_accepted_common(
        ...
        System::builder()
            ...
            .run(move || {
                ...
                let requested =
                    Arc::new(RwLock::new(HashSet::<(String, Vec<u64>, ChunkHash)>::new()));
                let responded =
                ...
                let (_, conn, _) = setup_mock_all_validators(
                    ...
                    Arc::new(RwLock::new(Box::new(
                        move |sender_account_id: String, msg: &NetworkRequests| {
                            let mut seen_chunk_same_sender =
                                seen_chunk_same_sender.write().unwrap();
