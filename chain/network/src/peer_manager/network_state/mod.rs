...
pub(crate) struct NetworkState {
    ...
    #[cfg(feature = "distance_vector_routing")]
    update_routes_processor:
        BatchProcessor<crate::routing::NetworkTopologyChange, Result<(), ReasonForBan>>,
...
impl NetworkState {
    pub fn new(
        ...
        Self {
            ...
            whitelist_nodes,
            add_edges_processor: BatchProcessor::new(
                config.routing_table_update_rate_limit,
                future_spawner,
            ),
            #[cfg(feature = "distance_vector_routing")]
            update_routes_processor: BatchProcessor::new(
                config.routing_table_update_rate_limit,
                future_spawner,
            ),
