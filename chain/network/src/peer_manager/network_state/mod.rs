...
use crate::state_witness_distribution::StateWitnessDistributionSenderForNetwork;
...
pub(crate) struct NetworkState {
    ...
    pub state_witness_distribution_adapter: StateWitnessDistributionSenderForNetwork,
...
impl NetworkState {
    pub fn new(
        ...
        state_witness_distribution_adapter: StateWitnessDistributionSenderForNetwork,
        whitelist_nodes: Vec<WhitelistNode>,
    ) -> Self {
        Self {
            runtime: Runtime::new(),
