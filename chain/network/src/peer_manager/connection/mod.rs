...
use crate::network_protocol::{
    PeerInfo, PeerMessage, RawTieredMessageBody, SignedAccountData, SignedOwnedAccount,
...
impl tcp::Tier {
    ...
    pub(crate) fn is_allowed_routed(self, body: &RawTieredMessageBody) -> bool {
        match body {
            RawTieredMessageBody::T1(..) => true,
            RawTieredMessageBody::T2(..) => self == tcp::Tier::T2,
        }
    }
}
