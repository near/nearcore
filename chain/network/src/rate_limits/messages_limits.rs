...
impl Config {
    ...
    pub fn standard_preset() -> Self {
        ...
        // EpochSyncResponse carries a large compressed proof (up to 500 MiB uncompressed).
        // Rate limit to prevent peers from flooding us with expensive-to-decode responses.
        config.rate_limits.insert(
