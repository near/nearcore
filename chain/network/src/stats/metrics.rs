use crate::network_protocol::RawTieredMessageBody;
use crate::network_protocol::{Encoding, VersionedRoutedMessage};
use crate::tcp;
...
fn record_routed_msg_hops(msg: &VersionedRoutedMessage) {
