...
fn default_validator_config() -> Option<ValidatorConfig> {
    None
}

fn default_event_sink() -> Sink<Event> {
    Sink::null()
}
...
pub struct NetworkConfig {
    ...
    #[serde(skip, default = "default_validator_config")]
    ...
    #[serde(skip, default = "default_event_sink")]
