...
//! WARNING WARNING WARNING
//! We need to maintain backwards compatibility, all changes to this file needs
//! to be reviews.
...
// Use custom deserializer for HandshakeV2. Try to read version of the other
// peer from the header. If the version is supported then fallback to standard
// deserializer.
...
/// Warning, position of each message type in this enum defines the protocol due
/// to serialization. DO NOT MOVE, REORDER, DELETE items from the list. Only add
/// new items to the end. If need to remove old items - replace with `None`.
...
#[cfg(target_arch = "x86_64")] // Non-x86_64 doesn't match this requirement yet but it's not bad as it's not
                               // production-ready
