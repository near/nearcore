...
mod test {
    ...
    impl TestEnv {
        pub fn new(
            ...
            genesis.config.block_producer_kickout_threshold = block_producer_kickout_threshold;
            genesis.config.chunk_producer_kickout_threshold = block_producer_kickout_threshold;
            if !has_reward {
    ...
    fn test_multiple_shards() {
        ...
        let mut env = TestEnv::new(
            ...
            vec![],
            false,
            // block_producer_kickout_threshold = 101 is needed to include all validators and pass the test
            101,
        );
        let block_producers: Vec<_> = validators
            .iter()
