...
/// How much weight horizon to give to consider peer up to date.
/// TODO: this really should depend more on the height * by number of block producers.
pub const MOST_WEIGHTED_PEER_HORIZON: u128 = 100;
