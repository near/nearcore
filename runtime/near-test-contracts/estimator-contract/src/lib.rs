...
pub unsafe fn bls12_381_verify_elements_1000_100() {
    ...
    let agg_sig: [u8; 96] = [130, 27, 206, 219, 194, 70, 81, 231, 14, 103, 140, 167, 143, 17, 90, 140, 229, 51, 156, 66, 180, 17, 40, 58, 182, 222, 150, 250, 237, 56, 202, 183, 114, 77, 254, 55, 140, 163, 195, 179, 214, 43, 239, 22, 242, 178, 203, 190, 23, 212, 45, 104, 22, 138, 251, 188, 176, 20, 137, 246, 242, 92, 163, 33, 142, 96, 247, 53, 143, 140, 173, 244, 148, 8, 23, 57, 132, 48, 179, 252, 58, 86, 191, 133, 121, 159, 154, 21, 127, 185, 67, 232, 178, 226, 137, 189];
    let mut pks: [u8; PUBKEY_LEN * N] = [0; PUBKEY_LEN * N];
    for i in 0..N {
        for j in 0..PUBKEY_LEN {
            pks[i * PUBKEY_LEN + j] = pk[j];
        }
    }
