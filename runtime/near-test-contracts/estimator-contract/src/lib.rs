...
pub unsafe fn bls12381_g1_sum_0_100() {
    let buffer: [u8; 0] = [];

    for _ in 0..100 {
        assert_eq!(bls12381_g1_sum(
            core::mem::size_of_val(&buffer) as u64,
            buffer.as_ptr() as *const u64 as u64,
            0,
        ), 0);
...
#[no_mangle]
#[cfg(feature = "protocol_feature_bls12381")]
pub unsafe fn bls12381_g1_sum_50_100() {
...
#[no_mangle]
#[cfg(feature = "protocol_feature_bls12381")]
pub unsafe fn bls12381_g2_sum_0_100() {
    let buffer: [u8; 0] = [];

    for _ in 0..100 {
        assert_eq!(bls12381_g2_sum(
            core::mem::size_of_val(&buffer) as u64,
            buffer.as_ptr() as *const u64 as u64,
            0,
        ), 0);
...
#[no_mangle]
#[cfg(feature = "protocol_feature_bls12381")]
pub unsafe fn bls12381_g2_sum_50_100() {
