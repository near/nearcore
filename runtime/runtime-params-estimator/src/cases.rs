...
pub fn run(config: Config) {
    ...
    for (method_name, n) in &[
        ("call_input", 1),
        ("call_input_register_len", 1),
        ("call_input_read_register", 1),
        ("call_current_account_id", 1),
        ("call_signer_account_id", 1),
        ("call_signer_account_pk", 1),
        ("call_predecessor_account_id", 1),
        ("call_block_index", 1),
        ("call_storage_usage", 1),
        ("call_account_balance", 1),
        ("call_attached_deposit", 1),
        ("call_prepaid_gas", 1),
        ("call_used_gas", 1),
        ("call_random_seed", 1),
        ("call_sha256", 1),
        ...
        ("call_log_utf8", 1),
        ("call_log_utf16", 1),
        ("call_promise_batch_create", 1),
        ("call_promise_batch_create_promise_batch_then", 1),
        ("call_promise_batch_create_promise_batch_action_create_account", 1),
        ("call_promise_batch_create_promise_batch_action_deploy_contract", 1),
        ("call_promise_results_count", 1),
        ("call_promise_batch_create_promise_return", 1),
        ("call_storage_write", 1),
        ("call_storage_read", 1),
        ("call_storage_remove", 1),
        ("call_storage_has_key", 1),
        ("call_storage_iter_prefix", 1),
        ("call_storage_iter_range", 1),
        ("call_storage_iter_next", 1),
    ] {
