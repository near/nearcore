...
pub fn run(config: Config) {
    ...
    *curr_code.borrow_mut() = code_1m.to_vec();
    ...
    for (allow_failures, metric, method_name, arg_size) in vec![
        ...
        (false, Metric::CallInputReadRegister1KW10KB, "input_read_register_1k", 10 * 1024),
