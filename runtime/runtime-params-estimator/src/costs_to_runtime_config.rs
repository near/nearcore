...
fn estimation(cost: ExtCosts) -> Option<Cost> {
    Some(match cost {
        ...
        ExtCosts::bls12381_g1_multiexp_element_div_log => Cost::Bls12381G1MultiexpElementDivLog,
        ...
        ExtCosts::bls12381_g2_multiexp_element_div_log => Cost::Bls12381G2MultiexpElementDivLog,
        ...
        ExtCosts::bls12381_g2_decompress_base => Cost::Bls12381G2DecompressBase,
        ExtCosts::bls12381_g2_decompress_element=> Cost::Bls12381G2DecompressElement,
        _ => return None,
    })
}
