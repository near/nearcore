...
fn runtime_fees_config(cost_table: &CostTable) -> anyhow::Result<RuntimeFeesConfig> {
    ...
    let res = RuntimeFeesConfig {
        action_fees: enum_map::enum_map! {
            ...
            ActionCosts::action_use_global_contract_base => fee(Cost::ActionUseGlobalContractBase)?,
            ActionCosts::action_use_global_contract_byte => fee(Cost::ActionUseGlobalContractPerByte)?,
        },
