...
fn estimation(cost: ExtCosts) -> Option<Cost> {
    Some(match cost {
        ...
        ExtCosts::bls12381_p1_multiexp_element_div_log => Cost::Bls12381P1MultiexpElementDivLog,
        ...
        ExtCosts::bls12381_p2_multiexp_element_div_log => Cost::Bls12381P2MultiexpElementDivLog,
