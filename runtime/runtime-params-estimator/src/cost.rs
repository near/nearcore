...
pub enum Cost {
    ...
    GasMeteringBase,
    GasMeteringOp,
    RocksDbInsertSeqValueKByte,
    RocksDbInsertSeqValueCompactedKByte,
    RocksDbInsertSeqValue100KByte,
    RocksDbInsertSeqValueCompacted100KByte,
    RocksDbInsertRandValueKByte,
    RocksDbInsertRandValueCompactedKByte,
    RocksDbInsertRandValue100KByte,
    RocksDbInsertRandValueCompacted100KByte,
    RocksDbReadSeqValueKByte,
    RocksDbReadSeqValueCompactedKByte,
    RocksDbReadSeqValue100KByte,
    RocksDbReadSeqValueCompacted100KByte,
    RocksDbReadRandValueKByte,
    RocksDbReadRandValueCompactedKByte,
    RocksDbReadRandValue100KByte,
    RocksDbReadRandValueCompacted100KByte,
    IoReadByte,
    IoWriteByte,
    CpuBenchmarkSha256,
    OneCPUInstruction,
