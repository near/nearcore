...
lazy_static! {
    pub static ref ACTION_CREAT_ACCOUNT_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
        "action_create_account_total",
        "The number of CreateAccount actions called since starting this node"
    );

    pub static ref ACTION_DEPLOY_CONTRACT_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
        "action_deploy_contract_total",
        "The number of DeployContract actions called since starting this node"
    );

    pub static ref ACTION_FUNCTION_CALL_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
    ...
    pub static ref ACTION_DELETE_KEY_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
        "action_delete_key_total",
        "The number of DeleteKey actions called since starting this node"
    );

    pub static ref ACTION_DELETE_ACCOUNT_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
        "action_delete_account_total",
        "The number of DeleteAccount actions called since starting this node"
    );

    pub static ref TRANSACTION_PROCESSED_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
        "transaction_processed_total",
        "The number of transactions processed since starting this node"
    );

    pub static ref TRANSACTION_PROCESSED_SUCCESSFULLY_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
        "transaction_processed_successefully_total",
        "The number of transactions processed successfully since starting this node"
    );

    pub static ref TRANSACTION_PROCESSED_FAILED_TOTAL: near_metrics::Result<IntCounter> = try_create_int_counter(
