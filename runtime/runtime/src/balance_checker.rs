...
mod tests {
    ...
    use near_store::{set_account, TrieUpdate, TrieUpdateEvent};
    ...
    fn test_check_balance_refund() {
        ...
        initial_state.commit(TrieUpdateEvent::NonFinalizable);
        ...
        final_state.commit(TrieUpdateEvent::NonFinalizable);
