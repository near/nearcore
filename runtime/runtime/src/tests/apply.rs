...
fn test_apply_delayed_receipts_local_tx() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[0].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 0
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[1].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 1
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[2].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 2
        ],
        "STEP #1 failed",
    ...
    assert_eq!(
        ...
        vec![
            ...
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[4].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 4
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[3].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 3
    ...
    assert_eq!(
        ...
        vec![
            ...
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[5].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 5
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[6].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 6
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[7].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 7
        ],
        "STEP #3 failed",
    ...
    assert_eq!(
        ...
        vec![
            ...
            *receipts[2].receipt_id(), // receipt #2
            create_receipt_id_from_transaction(
                ValidatedTransaction::new_for_test(local_transactions[8].clone()).to_signed_tx().hash(),
                apply_state.block_height,
            ), // receipt for tx 8
        ],
        "STEP #4 failed",
