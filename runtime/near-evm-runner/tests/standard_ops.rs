mod tests {
    ...
    fn test_meta_call_sig_and_recover() {
        ...
        let meta_tx3 = encode_meta_call_function_args(
            ...
            hex::decode("e009de88436170734c6f636b940123456789012345678901234567890123456789")
                .unwrap(),
        );
    ...
    #[test]
    fn test_ecrecover() {
        let msg2 = hex::decode("c1719db355fee5122b0625b9274ee6d385ced2f2a530d0de2edb77b541d52c3e")
            .unwrap();
        let mut msg = [0u8; 32];
