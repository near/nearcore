...
impl<'a> FuncGen<'a> {
    ...
    #[tracing::instrument(target = "near_vm", level = "debug", skip(self))]
...
#[tracing::instrument(target = "near_vm", level = "debug")]
...
#[tracing::instrument(target = "near_vm", level = "debug", skip(vmoffsets))]
