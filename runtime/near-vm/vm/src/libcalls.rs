...
impl LibCall {
    ...
    pub fn function_pointer(self) -> usize {
        match self {
            Self::CeilF32 => near_vm_f32_ceil as *const () as usize,
            Self::CeilF64 => near_vm_f64_ceil as *const () as usize,
            Self::FloorF32 => near_vm_f32_floor as *const () as usize,
            Self::FloorF64 => near_vm_f64_floor as *const () as usize,
            Self::NearestF32 => near_vm_f32_nearest as *const () as usize,
            Self::NearestF64 => near_vm_f64_nearest as *const () as usize,
            Self::TruncF32 => near_vm_f32_trunc as *const () as usize,
            Self::TruncF64 => near_vm_f64_trunc as *const () as usize,
            Self::Memory32Size => near_vm_memory32_size as *const () as usize,
            Self::ImportedMemory32Size => near_vm_imported_memory32_size as *const () as usize,
            Self::TableCopy => near_vm_table_copy as *const () as usize,
            Self::TableInit => near_vm_table_init as *const () as usize,
            Self::TableFill => near_vm_table_fill as *const () as usize,
            Self::TableSize => near_vm_table_size as *const () as usize,
            Self::ImportedTableSize => near_vm_imported_table_size as *const () as usize,
            Self::TableGet => near_vm_table_get as *const () as usize,
            Self::ImportedTableGet => near_vm_imported_table_get as *const () as usize,
            Self::TableSet => near_vm_table_set as *const () as usize,
            Self::ImportedTableSet => near_vm_imported_table_set as *const () as usize,
            Self::TableGrow => near_vm_table_grow as *const () as usize,
            Self::ImportedTableGrow => near_vm_imported_table_grow as *const () as usize,
            Self::FuncRef => near_vm_func_ref as *const () as usize,
            Self::ElemDrop => near_vm_elem_drop as *const () as usize,
            Self::Memory32Copy => near_vm_memory32_copy as *const () as usize,
            Self::ImportedMemory32Copy => near_vm_imported_memory32_copy as *const () as usize,
            Self::Memory32Fill => near_vm_memory32_fill as *const () as usize,
            Self::ImportedMemory32Fill => near_vm_memory32_fill as *const () as usize,
            Self::Memory32Init => near_vm_memory32_init as *const () as usize,
            Self::DataDrop => near_vm_data_drop as *const () as usize,
            Self::Probestack => near_vm_probestack as usize,
            Self::RaiseTrap => near_vm_raise_trap as *const () as usize,
        }
    }
