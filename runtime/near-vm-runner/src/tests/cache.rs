...
fn test_wasmer2_artifact_output_stability() {
    ...
    let prepared_hashes = [
        10654608132802939610,
        18250388544870699570,
        4603889850012169028,
        6464846330354232321,
        1869014857507340107,
        6135275611585960591,
    ...
    let compiled_hashes = [
        ...
        7247086573591576808,
        314880313967575062,
        12984856331242653341,
        8110669732320646529,
        17636335817210160820,
    ];
...
fn test_near_vm_artifact_output_stability() {
    ...
    let prepared_hashes = [
        ...
        13240867332361775628,
        11927859189830504440,
        17326556644719474042,
        10261775643075224482,
        5202448286961627098,
        9926621694204695735,
        1683754824992685273,
    ];
    ...
    let compiled_hashes = [
        // See the above comment if you want to change this
        18391985300610558439,
        8885260710356319072,
        12461153901260903968,
        10797424677681296897,
        11865642680512852696,
        9894824832013256071,
        905914661728907008,
    ];
    let mut got_compiled_hashes = Vec::with_capacity(seeds.len());
