...
impl TestBuilder {
    ...
    // We only test trapping tests on Wasmer, as of version 0.17, when tests
    // executed in parallel, Wasmer signal handlers may catch signals thrown
    // from the Wasmtime, and produce fake failing tests.
