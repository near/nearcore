...
imports! {
    ...
    prepaid_gas<[] -> [u64]>,
    used_gas<[] -> [u64]>,
    #["protocol_feature_gas_price_host_fn", GasPriceHostFn] burn_gas_price<[price_ptr: u64] -> []>,
    #["protocol_feature_gas_price_host_fn", GasPriceHostFn] purchased_gas_price<[price_ptr: u64] -> []>,
    // ############
    // # Math API #
    // ############
