...
wrapped_imports! {
    ...
    #["stable", MathExtension] ripemd160<[value_len: u64, value_ptr: u64, register_id: u64] -> []>,
    #["stable", MathExtension] ecrecover<[hash_len: u64, hash_ptr: u64, sign_len: u64, sig_ptr: u64, v: u64, malleability_flag: u64, register_id: u64] -> [u64]>,
    // #####################
    // # Miscellaneous API #
    // #####################
