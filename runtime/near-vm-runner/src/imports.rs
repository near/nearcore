...
imports! {
    ...
    #[sha3_256_host_fn] sha3_256<[value_len: u64, value_ptr: u64, register_id: u64] -> []>,
    #[sha3_384_512_host_fns] sha3_384<[value_len: u64, value_ptr: u64, register_id: u64] -> []>,
    #[sha3_384_512_host_fns] sha3_512<[value_len: u64, value_ptr: u64, register_id: u64] -> []>,
