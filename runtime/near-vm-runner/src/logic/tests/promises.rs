...
fn test_promise_batch_action_function_call() {
    ...
    promise_batch_action_function_call(&mut logic, 123, 0, Gas::from_gas(0))
    ...
    promise_batch_action_function_call(&mut logic, non_receipt, 0, Gas::from_gas(0))
        .expect_err("shouldn't accept non-receipt promise index");

    promise_batch_action_function_call(&mut logic, index, 0, Gas::from_gas(0))
