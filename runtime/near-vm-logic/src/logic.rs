...
impl<'a> VMLogic<'a> {
    ...
    /// # Errors
    ///
    /// If the input data is incorrect returns [HostError::Bls1238VerifyError]
    ///
    /// # Cost
    ///
    ...
    /// Special wekendimport kept for compatibility with AssemblyScript contracts. Not called by smart
