...
impl Default for ExtCostsConfig {
    fn default() -> ExtCostsConfig {
        ExtCostsConfig {
            base: SAFETY_MULTIPLIER * 88429085,
            read_memory_base: SAFETY_MULTIPLIER * 773923915,
            read_memory_byte: SAFETY_MULTIPLIER * 1266318,
            write_memory_base: SAFETY_MULTIPLIER * 95327640,
            write_memory_byte: SAFETY_MULTIPLIER * 874985,
            read_register_base: SAFETY_MULTIPLIER * 743687111,
            read_register_byte: SAFETY_MULTIPLIER * 31955,
            write_register_base: SAFETY_MULTIPLIER * 73022018,
            write_register_byte: SAFETY_MULTIPLIER * 7,
            utf8_decoding_base: SAFETY_MULTIPLIER * 162997218,
            utf8_decoding_byte: SAFETY_MULTIPLIER * 96359,
            utf16_decoding_base: SAFETY_MULTIPLIER * 323612618,
            utf16_decoding_byte: SAFETY_MULTIPLIER * 6592872,
            sha256_base: SAFETY_MULTIPLIER * 651203831,
            sha256_byte: SAFETY_MULTIPLIER * 6626443,
            keccak256_base: SAFETY_MULTIPLIER * 1097138631,
            keccak256_byte: SAFETY_MULTIPLIER * 5700785,
            keccak512_base: SAFETY_MULTIPLIER * 1074127478,
            keccak512_byte: SAFETY_MULTIPLIER * 10762570,
            log_base: 0,
            log_byte: 0,
            storage_write_base: SAFETY_MULTIPLIER * 13359081673,
            storage_write_key_byte: SAFETY_MULTIPLIER * 19416882,
            storage_write_value_byte: SAFETY_MULTIPLIER * 7084061,
            storage_write_evicted_byte: 0,
            storage_read_base: SAFETY_MULTIPLIER * 9743366720,
            storage_read_key_byte: SAFETY_MULTIPLIER * 7180693,
            storage_read_value_byte: SAFETY_MULTIPLIER * 47159,
            storage_remove_base: SAFETY_MULTIPLIER * 11051260769,
            storage_remove_key_byte: SAFETY_MULTIPLIER * 9337676,
            storage_remove_ret_value_byte: SAFETY_MULTIPLIER * 94568,
            storage_has_key_base: SAFETY_MULTIPLIER * 9586751818,
            storage_has_key_byte: SAFETY_MULTIPLIER * 7175135,
            ...
            promise_and_base: 0,
            promise_and_per_promise: SAFETY_MULTIPLIER * 541550,
            promise_return: SAFETY_MULTIPLIER * 97824365,
        }
    }
}
