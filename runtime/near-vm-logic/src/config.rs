...
impl Default for VMConfig {
    fn default() -> VMConfig {
        VMConfig {
            ...
            grow_mem_cost: 1,
            regular_op_cost: SAFETY_MULTIPLIER as u32 * 1147854 as u32,
...
impl Default for ExtCostsConfig {
    fn default() -> ExtCostsConfig {
        ExtCostsConfig {
            base: SAFETY_MULTIPLIER * 84575327,
            contract_compile_base: SAFETY_MULTIPLIER * 11833728,
            contract_compile_bytes: SAFETY_MULTIPLIER * 73375,
            read_memory_base: SAFETY_MULTIPLIER * 501905375,
            read_memory_byte: SAFETY_MULTIPLIER * 1267009,
            write_memory_base: SAFETY_MULTIPLIER * 566794187,
            write_memory_byte: SAFETY_MULTIPLIER * 907701,
            read_register_base: SAFETY_MULTIPLIER * 471353425,
            read_register_byte: SAFETY_MULTIPLIER * 32507,
            write_register_base: SAFETY_MULTIPLIER * 587700787,
            write_register_byte: SAFETY_MULTIPLIER * 1267091,
            utf8_decoding_base: SAFETY_MULTIPLIER * 670250537,
            utf8_decoding_byte: SAFETY_MULTIPLIER * 97180636,
            utf16_decoding_base: SAFETY_MULTIPLIER * 813550725,
            utf16_decoding_byte: SAFETY_MULTIPLIER * 54504135,
            sha256_base: SAFETY_MULTIPLIER * 1146194875,
            sha256_byte: SAFETY_MULTIPLIER * 8015961,
            keccak256_base: SAFETY_MULTIPLIER * 1591671787,
            keccak256_byte: SAFETY_MULTIPLIER * 7121085,
            keccak512_base: SAFETY_MULTIPLIER * 1569063037,
            keccak512_byte: SAFETY_MULTIPLIER * 12180617,
            log_base: SAFETY_MULTIPLIER * 813550725,
            log_byte: SAFETY_MULTIPLIER * 4375982,
            storage_write_base: SAFETY_MULTIPLIER * 17615742500,
            storage_write_key_byte: SAFETY_MULTIPLIER * 23200696,
            storage_write_value_byte: SAFETY_MULTIPLIER * 17646489,
            storage_write_evicted_byte: SAFETY_MULTIPLIER * 10349316,
            storage_read_base: SAFETY_MULTIPLIER * 14791192750,
            storage_read_key_byte: SAFETY_MULTIPLIER * 10038355,
            storage_read_value_byte: SAFETY_MULTIPLIER * 1521918,
            storage_remove_base: SAFETY_MULTIPLIER * 14330079250,
            storage_remove_key_byte: SAFETY_MULTIPLIER * 12440686,
            storage_remove_ret_value_byte: SAFETY_MULTIPLIER * 3068415,
            storage_has_key_base: SAFETY_MULTIPLIER * 14165954875,
            storage_has_key_byte: SAFETY_MULTIPLIER * 9946660,
            ...
            touching_trie_node: SAFETY_MULTIPLIER * 4226055071,
            promise_and_base: SAFETY_MULTIPLIER * 451875090,
            promise_and_per_promise: SAFETY_MULTIPLIER * 1824735,
            promise_return: SAFETY_MULTIPLIER * 150103236,
