...
const SAFETY_MULTIPLIER: u64 = 2;

impl Default for ExtCostsConfig {
    fn default() -> ExtCostsConfig {
        ExtCostsConfig {
            base: SAFETY_MULTIPLIER * 85064764,
            contract_compile_base: SAFETY_MULTIPLIER * 41206612500,
            contract_compile_bytes: SAFETY_MULTIPLIER * 348441148,
            read_memory_base: SAFETY_MULTIPLIER * 242295987,
            read_memory_byte: SAFETY_MULTIPLIER * 1266954,
            write_memory_base: SAFETY_MULTIPLIER * 304163037,
            write_memory_byte: SAFETY_MULTIPLIER * 61619,
            read_register_base: SAFETY_MULTIPLIER * 210041100,
            read_register_byte: SAFETY_MULTIPLIER * 32243,
            write_register_base: SAFETY_MULTIPLIER * 335271712,
            write_register_byte: SAFETY_MULTIPLIER * 1267043,
            utf8_decoding_base: SAFETY_MULTIPLIER * 423572562,
            utf8_decoding_byte: SAFETY_MULTIPLIER * 101527690,
            utf16_decoding_base: SAFETY_MULTIPLIER * 101527690,
            utf16_decoding_byte: SAFETY_MULTIPLIER * 56215617,
            sha256_base: SAFETY_MULTIPLIER * 877123262,
            sha256_byte: SAFETY_MULTIPLIER * 7683598,
            keccak256_base: SAFETY_MULTIPLIER * 1318006375,
            keccak256_byte: SAFETY_MULTIPLIER * 7080656,
            keccak512_base: SAFETY_MULTIPLIER * 1312660762,
            keccak512_byte: SAFETY_MULTIPLIER * 12105483,
            log_base: SAFETY_MULTIPLIER * 12105483,
            log_byte: SAFETY_MULTIPLIER * 4202095,
            storage_write_base: SAFETY_MULTIPLIER * 16180575000,
            storage_write_key_byte: SAFETY_MULTIPLIER * 24746203,
            storage_write_value_byte: SAFETY_MULTIPLIER * 1860417767,
            storage_write_evicted_byte: SAFETY_MULTIPLIER * 2941830261,
            storage_read_base: SAFETY_MULTIPLIER * 23963175750,
            storage_read_key_byte: SAFETY_MULTIPLIER * 5106293745,
            storage_read_value_byte: SAFETY_MULTIPLIER * 4859046121,
            storage_remove_base: SAFETY_MULTIPLIER * 31677757250,
            storage_remove_key_byte: SAFETY_MULTIPLIER * 5966467419,
            storage_remove_ret_value_byte: SAFETY_MULTIPLIER * 5474176228,
            storage_has_key_base: SAFETY_MULTIPLIER * 21671689000,
            storage_has_key_byte: SAFETY_MULTIPLIER * 4698517740,
            ...
            touching_trie_node: SAFETY_MULTIPLIER * 6846621642,
            promise_and_base: SAFETY_MULTIPLIER * 5708935337,
            promise_and_per_promise: SAFETY_MULTIPLIER * 43495350,
            promise_return: SAFETY_MULTIPLIER * 5073699325,
