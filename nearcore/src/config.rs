...
pub const GAS_PRICE_ADJUSTMENT_RATE: Rational64 = Rational64::new_raw(1, 100);

/// Protocol treasury reward
pub const PROTOCOL_REWARD_RATE: Rational64 = Rational64::new_raw(1, 10);

/// Maximum inflation rate per year
pub const MAX_INFLATION_RATE: Rational64 = Rational64::new_raw(1, 20);

/// Protocol upgrade stake threshold.
pub const PROTOCOL_UPGRADE_STAKE_THRESHOLD: Rational64 = Rational64::new_raw(4, 5);
    ...
    match chain_id.as_ref() {
        ...
        _ => {
            ...
            let genesis_config = GenesisConfig {
                ...
                block_producer_kickout_threshold: BLOCK_PRODUCER_KICKOUT_THRESHOLD,
                chunk_producer_kickout_threshold: CHUNK_PRODUCER_KICKOUT_THRESHOLD,
                online_max_threshold: Rational64::new(99, 100),
                online_min_threshold: Rational64::new(BLOCK_PRODUCER_KICKOUT_THRESHOLD as i64, 100),
