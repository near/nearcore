...
use near_chain_configs::{
    ...
    default_view_client_num_state_requests_per_throttle_period, get_initial_supply,
};
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            view_client_num_state_requests_per_throttle_period: default_view_client_num_state_requests_per_throttle_period(),
    ...
    pub fn new(
        ...
        Ok(NearConfig {
            ...
            client_config: ClientConfig {
                ...
                view_client_num_state_requests_per_throttle_period: config.view_client_num_state_requests_per_throttle_period,
