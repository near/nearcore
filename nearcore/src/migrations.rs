...
pub fn do_migrate_34_to_35(
    ...
    for shard_id in 2..num_shards {
        ...
        info!(target: "chain", %shard_id, "Start flat state shard migration, mem_usage = {} gb, sub_trie_size = {} gb", memory_usage as f64 / 10f64.powf(9), sub_trie_size as f64 / 10f64.powf(9));
