...
pub enum Transaction_oneof_body {
    signed_transaction(super::signed_transaction::SignedTransaction),
    receipt(Receipt),
}
...
impl Transaction {
    ...
    // Param is passed by value, moved
    pub fn set_signed_transaction(&mut self, v: super::signed_transaction::SignedTransaction) {
        self.body = ::std::option::Option::Some(Transaction_oneof_body::signed_transaction(v))
    }

    // Mutable pointer to the field.
    pub fn mut_signed_transaction(&mut self) -> &mut super::signed_transaction::SignedTransaction {
        if let ::std::option::Option::Some(Transaction_oneof_body::signed_transaction(_)) = self.body {
        } else {
            self.body = ::std::option::Option::Some(Transaction_oneof_body::signed_transaction(super::signed_transaction::SignedTransaction::new()));
        }
        match self.body {
    ...
    // Take field
    pub fn take_signed_transaction(&mut self) -> super::signed_transaction::SignedTransaction {
    ...
    pub fn get_signed_transaction(&self) -> &super::signed_transaction::SignedTransaction {
        match self.body {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18protos/transaction.proto\x1a\x1fprotos/signed_transaction.proto\"]\
    \n\x0cCallbackInfo\x12\x0e\n\x02id\x18\x01\x20\x01(\x0cR\x02id\x12!\n\
    \x0cresult_index\x18\x02\x20\x01(\x04R\x0bresultIndex\x12\x1a\n\x08recei\
    ver\x18\x03\x20\x01(\tR\x08receiver\"Q\n\x0eAccountingInfo\x12\x1e\n\nor\
    iginator\x18\x01\x20\x01(\tR\noriginator\x12\x1f\n\x0bcontract_id\x18\
    \x02\x20\x01(\tR\ncontractId\"\xe1\x01\n\x10AsyncCallReceipt\x12\x16\n\
    \x06amount\x18\x01\x20\x01(\x04R\x06amount\x12\x12\n\x04mana\x18\x02\x20\
    \x01(\rR\x04mana\x12\x1f\n\x0bmethod_name\x18\x03\x20\x01(\x0cR\nmethodN\
    ame\x12\x12\n\x04args\x18\x04\x20\x01(\x0cR\x04args\x122\n\rcallback_inf\
    o\x18\x05\x20\x01(\x0b2\r.CallbackInfoR\x0ccallbackInfo\x128\n\x0faccoun\
    ting_info\x18\x06\x20\x01(\x0b2\x0f.AccountingInfoR\x0eaccountingInfo\"R\
    \n\x15CallbackResultReceipt\x12!\n\x04info\x18\x01\x20\x01(\x0b2\r.Callb\
    ackInfoR\x04info\x12\x16\n\x06result\x18\x02\x20\x01(\x0cR\x06result\"'\
    \n\rRefundReceipt\x12\x16\n\x06amount\x18\x01\x20\x01(\x04R\x06amount\"\
    \x8d\x01\n\x15ManaAccountingReceipt\x128\n\x0faccounting_info\x18\x01\
    \x20\x01(\x0b2\x0f.AccountingInfoR\x0eaccountingInfo\x12\x1f\n\x0bmana_r\
    efund\x18\x02\x20\x01(\rR\nmanaRefund\x12\x19\n\x08gas_used\x18\x03\x20\
    \x01(\x04R\x07gasUsed\"\xc7\x02\n\x07Receipt\x12\x1e\n\noriginator\x18\
    \x01\x20\x01(\tR\noriginator\x12\x1a\n\x08receiver\x18\x02\x20\x01(\tR\
    \x08receiver\x12\x14\n\x05nonce\x18\x03\x20\x01(\x0cR\x05nonce\x122\n\na\
    sync_call\x18\x04\x20\x01(\x0b2\x11.AsyncCallReceiptH\0R\tasyncCall\x12A\
    \n\x0fcallback_result\x18\x05\x20\x01(\x0b2\x16.CallbackResultReceiptH\0\
    R\x0ecallbackResult\x12(\n\x06refund\x18\x06\x20\x01(\x0b2\x0e.RefundRec\
    eiptH\0R\x06refund\x12A\n\x0fmana_accounting\x18\x07\x20\x01(\x0b2\x16.M\
    anaAccountingReceiptH\0R\x0emanaAccountingB\x06\n\x04body\"\x80\x01\n\
    \x0bTransaction\x12C\n\x12signed_transaction\x18\x01\x20\x01(\x0b2\x12.S\
    ignedTransactionH\0R\x11signedTransaction\x12$\n\x07receipt\x18\x02\x20\
    \x01(\x0b2\x08.ReceiptH\0R\x07receiptB\x06\n\x04body\"@\n\x0cChainPayloa\
    d\x120\n\x0ctransactions\x18\x01\x20\x03(\x0b2\x0c.TransactionR\x0ctrans\
    actionsb\x06proto3\
";
