...
// impl Dispatcher {
//     pub fn new() -> Self {}
//     pub fn register<Data, Event>(&mut self, data: Data) -> DataHandle<Data, Event> {}

//     pub fn register_raw<Data>(&mut self, data: Data) -> Box<dyn Fn(&mut Self) -> &mut Data + Clone> {

//     }
// }

// // must impl Clone and Sync
// struct DataHandle<Data, Event> {}

// impl<Data, Event> DataHandle<Data, Event> {
//     pub fn data<'a>(&self, dispatcher: &'a Dispatcher) -> &'a Data {}

//     pub fn data_mut<'a>(&self, dispatcher: &'a mut Dispatcher) -> &'a mut Data {}

//     pub fn register_handler(
//         &self,
//         dispatcher: &mut Dispatcher,
//         handler: LoopEventHandler<Data, Event>,
//     ) {
//     }
...
//     let handle1 = dispatcher.register::<String, u32>("hello".to_string());
//     let handle2 = dispatcher.register::<String, u32>("world".to_string());
//     *handle1.data_mut(&mut dispatcher) = "goodbye".to_string();
//     handle1.register_handler(&mut dispatcher, LoopEventHandler::new_simple(|event, data| {
//         *data = format!("{}", event);
//     }));
//     let handler1_clone = handler1.clone();
//     handle2.register_handler(&mut dispatcher, LoopEventHandler::new_simple(|event, data| {
//         handler1_clone.send_message(event);
//     }));
//     handle2.send_message(42);
// }
