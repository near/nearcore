...
impl FakeClock {
    ...
    pub fn next_waiter(&self) -> Option<Instant> {
...
mod tests {
    ...
    #[test]
    fn test_serde_duration_skip_optional() {
        #[derive(serde::Serialize, serde::Deserialize)]
        struct Test {
            #[serde(skip_serializing_if = "Option::is_none")]
            #[serde(default)]
            #[serde(with = "super::serde_opt_duration_as_std")]
            dur: Option<Duration>,
        }

        let _: Test = serde_json::from_str("{}").unwrap();
    }
