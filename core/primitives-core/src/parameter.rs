...
pub enum Parameter {
    ...
    WasmVerifyBls12381Base,
    WasmVerifyBls12381Byte,
    WasmVerifyBls12381Elements,
    WasmLogBase,
    WasmLogByte,
...
impl Parameter {
    ...
    pub fn ext_costs() -> slice::Iter<'static, Parameter> {
        [
            ...
            Parameter::WasmVerifyBls12381Base,
            Parameter::WasmVerifyBls12381Byte,
            Parameter::WasmVerifyBls12381Elements,
