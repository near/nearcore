...
impl ExtCostsConfig {
    ...
    pub fn test_with_undercharging_factor(factor: u64) -> ExtCostsConfig {
        let costs = enum_map! {
            ...
            ExtCosts::bls12381_g1_sum_base => 0,
            ExtCosts::bls12381_g1_sum_element => 0,
            ExtCosts::bls12381_g2_sum_base => 0,
            ExtCosts::bls12381_g2_sum_element => 0,
            ExtCosts::bls12381_g1_multiexp_base => 0,
            ExtCosts::bls12381_g1_multiexp_element => 0,
            ExtCosts::bls12381_g1_multiexp_element_div_log => 0,
            ExtCosts::bls12381_g2_multiexp_base => 0,
            ExtCosts::bls12381_g2_multiexp_element => 0,
            ExtCosts::bls12381_g2_multiexp_element_div_log => 0,
            ...
            ExtCosts::bls12381_g2_decompress_base => 0,
            ExtCosts::bls12381_g2_decompress_element => 0,
        }
...
pub enum ExtCosts {
    ...
    bls12381_g1_sum_base = 61,
    bls12381_g1_sum_element = 62,
    bls12381_g2_sum_base = 63,
    bls12381_g2_sum_element = 64,
    bls12381_g1_multiexp_base = 65,
    bls12381_g1_multiexp_element = 66,
    bls12381_g1_multiexp_element_div_log = 67,
    bls12381_g2_multiexp_base = 68,
    bls12381_g2_multiexp_element = 69,
    bls12381_g2_multiexp_element_div_log = 70,
    bls12381_map_fp_to_g1_base = 71,
    bls12381_map_fp2_to_g2_base = 72,
    bls12381_pairing_base = 73,
    bls12381_pairing_element = 74,
    bls12381_g1_decompress_base = 75,
    bls12381_g1_decompress_element = 76,
    bls12381_g2_decompress_base = 77,
    bls12381_g2_decompress_element = 78,
}
...
impl ExtCosts {
    ...
    pub fn param(&self) -> Parameter {
        match self {
            ...
            ExtCosts::bls12381_g2_sum_element => Parameter::WasmBls12381G2SumElement,
            ...
            ExtCosts::bls12381_g1_multiexp_element_div_log => Parameter::WasmBls12381G1MultiexpElementDivLog,
            ...
            ExtCosts::bls12381_g2_multiexp_element_div_log => Parameter::WasmBls12381G2MultiexpElementDivLog,
            ...
            ExtCosts::bls12381_g2_decompress_base => Parameter::WasmBls12381G2DecompressBase,
            ExtCosts::bls12381_g2_decompress_element => Parameter::WasmBls12381G2DecompressElement,
        }
    }
}
