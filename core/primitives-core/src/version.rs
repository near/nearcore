...
impl ProtocolFeature {
    ...
    #[allow(deprecated, non_upper_case_globals)]
    pub const RejectBlocksWithOutdatedProtocolVersions: Self = Self::_DeprecatedRejectBlocksWithOutdatedProtocolVersions;
    #[allow(deprecated, non_upper_case_globals)]
    pub const FixChunkProducerStakingThreshold: Self = Self::_DeprecatedFixChunkProducerStakingThreshold;
