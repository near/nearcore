...
impl CloudStorageOpener {
    pub fn new(home_dir: std::path::PathBuf, config: CloudStorageConfig) -> Self {
        Self { _home_dir: home_dir, _config: config }
    }

    pub fn open(&self) -> io::Result<Arc<CloudStorage>> {
        unimplemented!("TODO(archival_v2): Implement opening cloud storage")
    }
}
...
pub fn update_cloud_storage(
    ...
    unimplemented!("TODO(archival_v2): Implement saving to cloud storage")
}
