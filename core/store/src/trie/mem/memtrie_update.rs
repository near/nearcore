...
use crate::trie::{Children, MemTrieChanges, OperationOptions, TrieRefcountDeltaMap};
...
impl<'a, M: ArenaMemory> MemTrieUpdate<'a, M> {
    ...
    pub fn insert_memtrie_only(
        ...
        self.generic_insert(0, key, GenericTrieValue::MemtrieOnly(value), OperationOptions::DEFAULT)
    }
}
...
mod tests {
    ...
    use crate::trie::{MemTrieChanges, OperationOptions};
    ...
    impl TestTries {
        ...
        fn make_all_changes(&mut self, changes: Vec<(Vec<u8>, Option<Vec<u8>>)>) -> TrieChanges {
            ...
            for (key, value) in changes {
                if let Some(value) = value {
                    ...
                    update.generic_delete(0, &key, OperationOptions::DEFAULT).unwrap();
                }
            }
        ...
        fn make_disk_changes_only(
            ...
            trie.update(changes, OperationOptions::DEFAULT).unwrap()
        }
