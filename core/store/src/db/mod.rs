...
pub trait SafeAny: Any + Sync + Send {}

impl<T: Any + Sync + Send> SafeAny for T {}
...
pub struct Anything {
    ...
    arc_id: TypeId,
    any: Arc<dyn SafeAny>,
    arc_any: Arc<dyn SafeAny>,
    //name: &'static str,
}

impl Anything {
    pub fn new<T: SafeAny>(value: T) -> Self {
...
impl DBTransaction {
    ...
    pub fn insert_anything<T: SafeAny>(
        &mut self,
        col: DBCol,
        key: Vec<u8>,
        value: Vec<u8>,
