...
mod tests {
    ...
    fn generated_bob_second_msg_in_kickout_epoch() {
        ...
        let (v0,v3,v4,v5,v6);
        let mut v = [None; 5];
        let test = |v:&[_]| make_assertions(&v, &[(0, None, false, 0), (0, None, false, 3), (0, None, false, 4), (1, None, true, 5), (1, None, false, 6)]);
        simple_messages!(0, &selector, arena [1, 0, true => v0;]); v[0] = Some(v0);
        test(&v);
        test_endorsements(v0, &[], 4);
        simple_messages!(0, &selector, arena [2, 0, true => v3;]); v[1] = Some(v3);
        test(&v);
        test_endorsements(v3, &[], 4);
        simple_messages!(0, &selector, arena [3, 0, true => v4;]); v[2] = Some(v4);
        test(&v);
        test_endorsements(v4, &[], 4);
        simple_messages!(0, &selector, arena [[=> v0; => v3; => v4; ] => 1, 0, true => v5;]); v[3] = Some(v5);
        test(&v);
        test_endorsements(v5, &[], 4);
        simple_messages!(0, &selector, arena [[=> v5; ] => 1, 0, true => v6;]); v[4] = Some(v6);
        test(&v);
    ...
    fn generated_kickouts() {
        ...
        test(&v);
        test_endorsements(v23, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3], vec![1, 2], vec![1, 2, 3], vec![], vec![1]], 4);
    }
    ...
    fn generated_no_endorse_after_kickout() {
        ...
        let mut v = [None; 12];
        let test = |v:&[_]| make_assertions(&v, &[(0, Some(0), false, 0), (0, None, false, 1), (0, None, false, 2), (0, None, false, 3), (1, None, true, 4), (1, None, false, 5), (1, None, false, 6), (1, None, false, 7), (1, None, false, 8), (2, Some(1), false, 9), (2, Some(2), false, 10), (2, None, false, 11)]);
        simple_messages!(0, &selector, arena [0, 0, true => v0;]); v[0] = Some(v0);
        test(&v);
        test_endorsements(v0, &[vec![0]], 4);
        simple_messages!(0, &selector, arena [1, 0, true => v1;]); v[1] = Some(v1);
        ...
        test(&v);
        test_endorsements(v4, &[], 4);
        simple_messages!(0, &selector, arena [[=> v4; ] => 2, 0, true => v5;]); v[5] = Some(v5);
        test(&v);
        test_endorsements(v5, &[], 4);
        simple_messages!(0, &selector, arena [[=> v4; ] => 3, 0, true => v6;]); v[6] = Some(v6);
        test(&v);
        test_endorsements(v6, &[], 4);
        simple_messages!(0, &selector, arena [[=> v0; => v5; ] => 2, 0, true => v7;]); v[7] = Some(v7);
        test(&v);
        test_endorsements(v7, &[vec![0]], 4);
        simple_messages!(0, &selector, arena [[=> v0; => v6; ] => 3, 0, true => v8;]); v[8] = Some(v8);
        test(&v);
        test_endorsements(v8, &[vec![0]], 4);
        simple_messages!(0, &selector, arena [[=> v7; => v8; ] => 1, 0, true => v9;]); v[9] = Some(v9);
        test(&v);
        test_endorsements(v9, &[vec![0], vec![1]], 4);
        simple_messages!(0, &selector, arena [[=> v9; ] => 2, 0, true => v10;]); v[10] = Some(v10);
        test(&v);
        test_endorsements(v10, &[vec![0], vec![1, 2], vec![2]], 4);
        simple_messages!(0, &selector, arena [[=> v9; ] => 3, 0, true => v11;]); v[11] = Some(v11);
        test(&v);
    ...
    fn generated_kickout_cases() {
        ...
        let mut v = [None; 17];
        let test = |v:&[_]| make_assertions(&v, &[(0, Some(0), false, 0), (0, None, false, 1), (0, None, false, 2), (0, None, false, 3), (1, Some(1), false, 4), (1, None, false, 5), (1, None, false, 6), (1, None, false, 7), (1, None, false, 8), (2, None, false, 9), (2, None, false, 10), (2, None, false, 11), (2, Some(2), false, 12), (3, None, true, 13), (3, None, false, 14), (3, None, false, 15), (3, None, false, 16)]);
        simple_messages!(0, &selector, arena [0, 0, true => v0;]); v[0] = Some(v0);
        test(&v);
        test_endorsements(v0, &[vec![0]], 4);
        simple_messages!(0, &selector, arena [[=> v0; ] => 2, 0, true => v1;]); v[1] = Some(v1);
        ...
        simple_messages!(0, &selector, arena [[=> v0; ] => 3, 0, true => v2;]); v[2] = Some(v2);
        test(&v);
        test_endorsements(v2, &[vec![0, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v1; => v2; ] => 1, 0, true => v3;]); v[3] = Some(v3);
        test(&v);
        test_endorsements(v3, &[vec![0, 1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v3; ] => 1, 0, true => v4;]); v[4] = Some(v4);
        test(&v);
        test_endorsements(v4, &[vec![0, 1, 2, 3], vec![1]], 4);
        simple_messages!(0, &selector, arena [[=> v4; ] => 3, 0, true => v5;]); v[5] = Some(v5);
        test(&v);
        test_endorsements(v5, &[vec![0, 1, 2, 3], vec![1, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v5; ] => 2, 0, true => v6;]); v[6] = Some(v6);
        test(&v);
        test_endorsements(v6, &[vec![0, 1, 2, 3], vec![1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v5; ] => 1, 0, true => v7;]); v[7] = Some(v7);
        test(&v);
        test_endorsements(v7, &[vec![0, 1, 2, 3], vec![1, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v5; ] => 0, 0, true => v8;]); v[8] = Some(v8);
        test(&v);
        test_endorsements(v8, &[vec![0, 1, 2, 3], vec![0, 1, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v6; => v7; => v8; ] => 3, 0, true => v9;]); v[9] = Some(v9);
        test(&v);
        test_endorsements(v9, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v6; => v7; => v8; ] => 1, 0, true => v10;]); v[10] = Some(v10);
        test(&v);
        test_endorsements(v10, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v6; => v7; => v8; ] => 0, 0, true => v11;]); v[11] = Some(v11);
        test(&v);
        test_endorsements(v11, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v6; => v7; => v8; ] => 2, 0, true => v12;]); v[12] = Some(v12);
        test(&v);
        test_endorsements(v12, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3], vec![2]], 4);
        simple_messages!(0, &selector, arena [[=> v9; => v10; => v11; ] => 3, 0, true => v13;]); v[13] = Some(v13);
        test(&v);
        test_endorsements(v13, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v12; => v13; ] => 1, 0, true => v14;]); v[14] = Some(v14);
        test(&v);
        test_endorsements(v14, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3], vec![1, 2]], 4);
        simple_messages!(0, &selector, arena [[=> v13; ] => 0, 0, true => v15;]); v[15] = Some(v15);
        test(&v);
        test_endorsements(v15, &[vec![0, 1, 2, 3], vec![0, 1, 2, 3]], 4);
        simple_messages!(0, &selector, arena [[=> v12; => v15; ] => 0, 0, true => v16;]); v[16] = Some(v16);
        test(&v);
    ...
    fn generated_kickouts_and_epoch_blocks_1() {
        ...
        let mut v = [None; 15];
        let test = |v:&[_]| make_assertions(&v, &[(0, Some(0), false, 0), (0, None, false, 1), (0, None, false, 2), (0, None, false, 3), (1, None, true, 4), (1, None, false, 5), (1, None, false, 6), (2, Some(1), false, 7), (2, None, true, 8), (2, None, false, 9), (2, None, false, 10), (3, Some(2), false, 11), (1, None, false, 12), (3, None, false, 13), (3, Some(3), false, 14)]);
        simple_messages!(0, &selector, arena [0, 0, true => v0;]); v[0] = Some(v0);
        test(&v);
        test_endorsements(v0, &[vec![0]], 4);
        simple_messages!(0, &selector, arena [1, 0, true => v1;]); v[1] = Some(v1);
        ...
        test(&v);
        test_endorsements(v5, &[], 4);
        simple_messages!(0, &selector, arena [[=> v5; ] => 3, 0, true => v6;]); v[6] = Some(v6);
        test(&v);
        test_endorsements(v6, &[], 4);
        simple_messages!(0, &selector, arena [[=> v6; ] => 1, 0, true => v7;]); v[7] = Some(v7);
        test(&v);
        test_endorsements(v7, &[vec![], vec![1]], 4);
        simple_messages!(0, &selector, arena [[=> v5; => v6; ] => 2, 0, true => v8;]); v[8] = Some(v8);
        test(&v);
        test_endorsements(v8, &[], 4);
        simple_messages!(0, &selector, arena [[=> v8; ] => 3, 0, true => v9;]); v[9] = Some(v9);
        test(&v);
        test_endorsements(v9, &[], 4);
        simple_messages!(0, &selector, arena [[=> v7; => v8; ] => 1, 0, true => v10;]); v[10] = Some(v10);
        test(&v);
        test_endorsements(v10, &[vec![], vec![1]], 4);
        simple_messages!(0, &selector, arena [[=> v0; => v9; => v10; ] => 2, 0, true => v11;]); v[11] = Some(v11);
        test(&v);
        test_endorsements(v11, &[vec![0], vec![1], vec![2]], 4);
        simple_messages!(0, &selector, arena [[=> v11; ] => 0, 0, true => v12;]); v[12] = Some(v12);
        test(&v);
        test_endorsements(v12, &[vec![0], vec![0, 1], vec![0, 2]], 4);
        simple_messages!(0, &selector, arena [[=> v11; ] => 1, 0, true => v13;]); v[13] = Some(v13);
        test(&v);
        test_endorsements(v13, &[vec![0], vec![1], vec![1, 2]], 4);
        simple_messages!(0, &selector, arena [[=> v11; ] => 3, 0, true => v14;]); v[14] = Some(v14);
        test(&v);
    ...
    fn generated_kickouts_and_epoch_blocks_2() {
        ...
        let (v0,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,v21,v22,v23,v24);
        let mut v = [None; 25];
        let test = |v:&[_]| make_assertions(&v, &[(0, None, false, 0), (0, Some(0), false, 1), (0, None, false, 2), (0, None, false, 3), (0, None, false, 4), (0, None, false, 5), (1, None, true, 6), (1, None, false, 7), (1, None, false, 8), (1, None, false, 9), (1, None, false, 10), (2, Some(1), false, 11), (2, None, true, 12), (2, None, false, 13), (2, None, false, 14), (2, None, false, 15), (0, None, false, 16), (2, Some(2), false, 17), (1, None, false, 18), (2, None, false, 19), (2, None, false, 20), (2, None, false, 21), (2, None, false, 22), (2, None, false, 23), (3, None, false, 24)]);
        simple_messages!(0, &selector, arena [1, 0, true => v0;]); v[0] = Some(v0);
        test(&v);
        test_endorsements(v0, &[], 7);
        simple_messages!(0, &selector, arena [0, 0, true => v1;]); v[1] = Some(v1);
        test(&v);
        test_endorsements(v1, &[vec![0]], 7);
        simple_messages!(0, &selector, arena [[=> v0; ] => 2, 0, true => v2;]); v[2] = Some(v2);
        test(&v);
        test_endorsements(v2, &[], 7);
        simple_messages!(0, &selector, arena [[=> v0; ] => 3, 0, true => v3;]); v[3] = Some(v3);
        test(&v);
        test_endorsements(v3, &[], 7);
        simple_messages!(0, &selector, arena [[=> v0; ] => 4, 0, true => v4;]); v[4] = Some(v4);
        test(&v);
        test_endorsements(v4, &[], 7);
        simple_messages!(0, &selector, arena [[=> v0; ] => 5, 0, true => v5;]); v[5] = Some(v5);
        test(&v);
        test_endorsements(v5, &[], 7);
        simple_messages!(0, &selector, arena [[=> v2; => v3; => v4; => v5; ] => 1, 0, true => v6;]); v[6] = Some(v6);
        test(&v);
        test_endorsements(v6, &[], 7);
        simple_messages!(0, &selector, arena [[=> v6; ] => 2, 0, true => v7;]); v[7] = Some(v7);
        test(&v);
        test_endorsements(v7, &[], 7);
        simple_messages!(0, &selector, arena [[=> v6; ] => 3, 0, true => v8;]); v[8] = Some(v8);
        test(&v);
        test_endorsements(v8, &[], 7);
        simple_messages!(0, &selector, arena [[=> v6; ] => 4, 0, true => v9;]); v[9] = Some(v9);
        test(&v);
        test_endorsements(v9, &[], 7);
        simple_messages!(0, &selector, arena [[=> v6; ] => 5, 0, true => v10;]); v[10] = Some(v10);
        test(&v);
        test_endorsements(v10, &[], 7);
        simple_messages!(0, &selector, arena [[=> v7; => v8; => v9; => v10; ] => 1, 0, true => v11;]); v[11] = Some(v11);
        test(&v);
        test_endorsements(v11, &[vec![], vec![1]], 7);
        simple_messages!(0, &selector, arena [[=> v7; => v8; => v9; => v10; ] => 2, 0, true => v12;]); v[12] = Some(v12);
        test(&v);
        test_endorsements(v12, &[], 7);
        simple_messages!(0, &selector, arena [[=> v11; ] => 3, 0, true => v13;]); v[13] = Some(v13);
        test(&v);
        test_endorsements(v13, &[vec![], vec![1, 3]], 7);
        simple_messages!(0, &selector, arena [[=> v11; ] => 4, 0, true => v14;]); v[14] = Some(v14);
        test(&v);
        test_endorsements(v14, &[vec![], vec![1, 4]], 7);
        simple_messages!(0, &selector, arena [[=> v11; ] => 5, 0, true => v15;]); v[15] = Some(v15);
        test(&v);
        test_endorsements(v15, &[vec![], vec![1, 5]], 7);
        simple_messages!(0, &selector, arena [[=> v11; ] => 6, 0, true => v16;]); v[16] = Some(v16);
        test(&v);
        test_endorsements(v16, &[vec![], vec![1, 6]], 7);
        simple_messages!(0, &selector, arena [[=> v1; => v11; => v12; ] => 2, 0, true => v17;]); v[17] = Some(v17);
        test(&v);
        test_endorsements(v17, &[vec![0], vec![1], vec![2]], 7);
        simple_messages!(0, &selector, arena [[=> v1; => v12; ] => 0, 0, true => v18;]); v[18] = Some(v18);
        test(&v);
        test_endorsements(v18, &[vec![0]], 7);
        simple_messages!(0, &selector, arena [[=> v13; => v14; => v15; => v16; ] => 1, 0, true => v19;]); v[19] = Some(v19);
        test(&v);
        test_endorsements(v19, &[vec![], vec![1, 3, 4, 5, 6]], 7);
        simple_messages!(0, &selector, arena [[=> v13; => v17; ] => 3, 0, true => v20;]); v[20] = Some(v20);
        test(&v);
        test_endorsements(v20, &[vec![0], vec![1, 3], vec![2, 3]], 7);
        simple_messages!(0, &selector, arena [[=> v14; => v17; ] => 4, 0, true => v21;]); v[21] = Some(v21);
        test(&v);
        test_endorsements(v21, &[vec![0], vec![1, 4], vec![2, 4]], 7);
        simple_messages!(0, &selector, arena [[=> v15; => v17; ] => 5, 0, true => v22;]); v[22] = Some(v22);
        test(&v);
        test_endorsements(v22, &[vec![0], vec![1, 5], vec![2, 5]], 7);
        simple_messages!(0, &selector, arena [[=> v17; => v18; ] => 0, 0, true => v23;]); v[23] = Some(v23);
        test(&v);
