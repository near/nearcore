...
impl ExtCostsConfig {
    ...
    pub fn test_with_undercharging_factor(factor: u64) -> ExtCostsConfig {
        let costs = enum_map! {
            ...
            ExtCosts::bls12381_p1_sum_base => 0,
            ExtCosts::bls12381_p1_sum_element => 0,
            ExtCosts::bls12381_p2_sum_base => 0,
            ExtCosts::bls12381_p2_sum_element => 0,
            ExtCosts::bls12381_p1_multiexp_base => 0,
            ExtCosts::bls12381_p1_multiexp_element => 0,
            ExtCosts::bls12381_p2_multiexp_base => 0,
            ExtCosts::bls12381_p2_multiexp_element => 0,
            ExtCosts::bls12381_map_fp_to_g1_base => 0,
            ExtCosts::bls12381_map_fp_to_g1_element => 0,
            ExtCosts::bls12381_map_fp2_to_g2_base => 0,
            ExtCosts::bls12381_map_fp2_to_g2_element => 0,
            ExtCosts::bls12381_pairing_base => 0,
            ExtCosts::bls12381_pairing_element => 0,
            ExtCosts::bls12381_p1_decompress_base => 0,
            ExtCosts::bls12381_p1_decompress_element => 0,
            ExtCosts::bls12381_p2_decompress_base => 0,
            ExtCosts::bls12381_p2_decompress_element => 0,
        }
