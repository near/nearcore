...
impl ExtCostsConfig {
    ...
    pub fn test_with_undercharging_factor(factor: u64) -> ExtCostsConfig {
        let costs = enum_map! {
            ...
            ExtCosts::bls12381_g1_sum_base => SAFETY_MULTIPLIER * 5_323_753_562,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g1_sum_element => SAFETY_MULTIPLIER * 1_849_277_517,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g2_sum_base => SAFETY_MULTIPLIER * 6_127_214_375,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g2_sum_element => SAFETY_MULTIPLIER * 4_795_078_317,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g1_multiexp_base => SAFETY_MULTIPLIER * 5_343_057_937,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g1_multiexp_element => SAFETY_MULTIPLIER * 227_964_264_224,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g2_multiexp_base => SAFETY_MULTIPLIER * 6_125_490_750,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g2_multiexp_element => SAFETY_MULTIPLIER * 579_026_575_661,
            #[cfg(feature = "protocol_feature_bls12381")]
...
pub enum ExtCosts {
    ...
    #[cfg(feature = "protocol_feature_bls12381")]
    bls12381_g1_sum_base = 65,
    #[cfg(feature = "protocol_feature_bls12381")]
    bls12381_g1_sum_element = 66,
    #[cfg(feature = "protocol_feature_bls12381")]
    bls12381_g2_sum_base = 67,
    #[cfg(feature = "protocol_feature_bls12381")]
    bls12381_g2_sum_element = 68,
    #[cfg(feature = "protocol_feature_bls12381")]
...
impl ExtCosts {
    ...
    pub fn param(&self) -> Parameter {
        match self {
            ...
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g1_sum_base => Parameter::WasmBls12381G1SumBase,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g1_sum_element => Parameter::WasmBls12381G1SumElement,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g2_sum_base => Parameter::WasmBls12381G2SumBase,
            #[cfg(feature = "protocol_feature_bls12381")]
            ExtCosts::bls12381_g2_sum_element => Parameter::WasmBls12381G1SumElement,
            #[cfg(feature = "protocol_feature_bls12381")]
