...
/// Add `shard_split`, remove challenges
#[derive(
    BorshSerialize,
    BorshDeserialize,
    serde::Serialize,
...
pub struct BlockHeaderInnerRestV7 {
    /// Hash of block body
    pub block_body_hash: CryptoHash,
    /// Root hash of the previous chunks' outgoing receipts in the given block.
    pub prev_chunk_outgoing_receipts_root: MerkleHash,
    ...
    /// Per-validator endorsement deltas derived from the previous block's
    /// body of spice core statements. Indexed by ValidatorId in this block's
    /// epoch. Length is either 0 (treated as all-zero, no-op for the
    /// aggregator) or exactly `epoch_info(epoch_id).validators.len()`.
...
/// V5 -> V6: Add shard_split, remove challenges
#[derive(
    BorshSerialize,
    BorshDeserialize,
    serde::Serialize,
...
impl BlockHeader {
    ...
    pub fn new(
        ...
        prev_spice_chunk_endorsement_stats: Option<Vec<SpiceChunkEndorsementStats>>,
    ) -> Self {
        Self::new_impl(
    ...
    fn new_impl(
        ...
        if ProtocolFeature::Spice.enabled(current_protocol_version) {
            ...
            let prev_spice_chunk_endorsement_stats = prev_spice_chunk_endorsement_stats.expect(
                "BlockHeaderV7 requires prev_spice_chunk_endorsement_stats when Spice is enabled",
            );
            ...
            Self::BlockHeaderV7(BlockHeaderV7 {
                prev_hash,
                inner_lite,
                inner_rest,
                signature,
        ...
        } else if ProtocolFeature::DynamicResharding.enabled(current_protocol_version) {
    ...
    pub fn genesis(
        ...
        let genesis_prev_last_certified_block_epoch_id =
            if ProtocolFeature::Spice.enabled(genesis_protocol_version) {
                Some(EpochId::default())
            } else {
                None
            };
        let genesis_prev_spice_chunk_endorsement_stats =
            if ProtocolFeature::Spice.enabled(genesis_protocol_version) {
                Some(Vec::new())
            } else {
                None
        ...
        Self::new_impl(
            ...
            genesis_prev_spice_chunk_endorsement_stats,
        )
    }
    ...
    pub fn hash(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.hash,
        }
    }
    ...
    pub fn prev_hash(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.prev_hash,
        }
    }
    ...
    pub fn signature(&self) -> &Signature {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.signature,
        }
    }
    ...
    pub fn height(&self) -> BlockHeight {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_lite.height,
        }
    }
    ...
    pub fn prev_height(&self) -> Option<BlockHeight> {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => Some(header.inner_rest.prev_height),
        }
    }
    ...
    pub fn epoch_id(&self) -> &EpochId {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_lite.epoch_id,
        }
    }
    ...
    pub fn next_epoch_id(&self) -> &EpochId {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_lite.next_epoch_id,
        }
    }
    ...
    pub fn prev_state_root(&self) -> &MerkleHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_lite.prev_state_root,
        }
    }
    ...
    pub fn chunk_headers_root(&self) -> &MerkleHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_rest.chunk_headers_root,
        }
    }
    ...
    pub fn chunk_tx_root(&self) -> &MerkleHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_rest.chunk_tx_root,
        }
    }
    ...
    pub fn outcome_root(&self) -> &MerkleHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_lite.prev_outcome_root,
        }
    }
    ...
    pub fn block_body_hash(&self) -> Option<CryptoHash> {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => Some(header.inner_rest.block_body_hash),
        }
    }
    ...
    pub fn raw_timestamp(&self) -> u64 {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_lite.timestamp,
        }
    }
    ...
    pub fn block_ordinal(&self) -> NumBlocks {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_rest.block_ordinal,
        }
    }
    ...
    pub fn next_gas_price(&self) -> Balance {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_rest.next_gas_price,
        }
    }
    ...
    pub fn total_supply(&self) -> Balance {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_rest.total_supply,
        }
    }
    ...
    pub fn random_value(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_rest.random_value,
        }
    }
    ...
    pub fn last_final_block(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_rest.last_final_block,
        }
    }
    ...
    pub fn last_ds_final_block(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_rest.last_ds_final_block,
        }
    }
    ...
    pub fn next_bp_hash(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_lite.next_bp_hash,
        }
    }
    ...
    pub fn block_merkle_root(&self) -> &CryptoHash {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_lite.block_merkle_root,
        }
    }
    ...
    pub fn epoch_sync_data_hash(&self) -> Option<CryptoHash> {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_rest.epoch_sync_data_hash,
        }
    }
    ...
    pub fn approvals(&self) -> &[Option<Box<Signature>>] {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => &header.inner_rest.approvals,
        }
    }
    ...
    pub fn verify_chunks_included(&self) -> bool {
        match self {
            ...
            BlockHeader::BlockHeaderV7(_header) => true,
        }
    }
    ...
    pub fn chunk_endorsements(&self) -> Option<&ChunkEndorsementsBitmap> {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => Some(&header.inner_rest.chunk_endorsements),
        }
    }
    ...
    pub fn challenges_present(&self) -> bool {
        ...
        let (challenges_root, challenges_result) = match self {
            ...
            Self::BlockHeaderV7(_) => return false,
        };
    ...
    pub fn shard_split(&self) -> Option<&(ShardId, AccountId)> {
        match self {
            ...
            BlockHeader::BlockHeaderV7(header) => header.inner_rest.shard_split.as_ref(),
        }
    }
    ...
    /// Per-validator endorsement deltas attributed to this block's epoch,
    /// derived from the previous block's spice core statements.
    /// Returns `None` for header versions prior to V7.
    #[inline]
    pub fn prev_spice_chunk_endorsement_stats(&self) -> Option<&[SpiceChunkEndorsementStats]> {
        match self {
            ...
            | BlockHeader::BlockHeaderV6(_) => None,
            BlockHeader::BlockHeaderV7(header) => {
                Some(&header.inner_rest.prev_spice_chunk_endorsement_stats)
            }
        }
    }
