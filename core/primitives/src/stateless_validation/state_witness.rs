...
pub struct ChunkApplyWitness {
    ...
    /// The header is supposed to use ShardChunkApplyHeaderInner
    pub chunk_header: ShardChunkHeader,
...
pub struct ChunkStateWitnessV3 {
    ...
    chunk_validate_witness: Option<ChunkValidateWitness>,
}
...
impl ChunkStateWitness {
    ...
    pub fn source_receipt_proofs(&self) -> &HashMap<ChunkHash, ReceiptProof> {
        match self {
            ...
            ChunkStateWitness::V3(witness) => &witness.chunk_apply_witness.source_receipt_proofs,
        }
    }
