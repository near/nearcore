...
impl BlockInfo {
    ...
    /// Constructs BlockInfo for a spice chain, embedding the epoch id of the
    /// last certified block reachable from `header`. EpochManager reads this
    /// to decide whether to advance to the next epoch.
