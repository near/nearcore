...
pub struct ChunkHeaderView {
    ...
    pub shard_id: ShardId,
    #[serde_as(as = "GasNumberSerialization<gas_usedGasFieldName>")]
...
impl From<ShardChunkHeader> for ChunkHeaderView {
    fn from(chunk: ShardChunkHeader) -> Self {
        ...
        ChunkHeaderView {
            ...
            gas_used: NearGas::from_gas(inner.prev_gas_used()),
            gas_limit: NearGas::from_gas(inner.gas_limit()),
            rent_paid: 0,
            validator_reward: 0,
...
pub struct ExecutionOutcomeView {
    ...
    #[serde_as(as = "GasNumberSerialization<gas_burntGasFieldName>")]
