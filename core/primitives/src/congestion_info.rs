...
#[derive(Clone, Debug, Default, Eq, PartialEq, BorshSerialize, BorshDeserialize, ProtocolSchema)]
...
#[derive(Debug, Default, Clone, Copy, PartialEq, Eq, BorshSerialize, BorshDeserialize, ProtocolSchema)]
