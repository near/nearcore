...
impl ShardLayout {
    ...
    /// Returns the simple nightshade layout used to test resharding on top of the latest protocol
    /// changes. Currently it is built on top of version 3.
    #[cfg(feature = "nightly")]
    pub fn get_simple_nightshade_layout_nightly() -> ShardLayout {
        ShardLayout::v1(
            vec![
                "aurora",
                "aurora-0",
