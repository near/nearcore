...
pub const PROTOCOL_UPGRADE_SCHEDULE: Lazy<ProtocolUpgradeVotingSchedule> = Lazy::new(|| {
    ...
    let v1_datetime = ProtocolUpgradeVotingSchedule::parse_datetime("2024-08-12 14:00:00").unwrap();
    let v2_datetime = ProtocolUpgradeVotingSchedule::parse_datetime("2024-08-14 04:00:00").unwrap();
