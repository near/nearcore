...
pub const PROTOCOL_UPGRADE_SCHEDULE: LazyLock<ProtocolUpgradeVotingSchedule> =
    LazyLock::new(|| {
        ...
        let v1_datetime =
            ProtocolUpgradeVotingSchedule::parse_datetime("2025-03-11 22:00:00").unwrap();

        let v2_datetime =
            ProtocolUpgradeVotingSchedule::parse_datetime("2025-03-16 10:00:00").unwrap();

        let v3_datetime =
            ProtocolUpgradeVotingSchedule::parse_datetime("2025-03-18 18:00:00").unwrap();
