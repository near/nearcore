...
pub const PROTOCOL_UPGRADE_SCHEDULE: Lazy<ProtocolUpgradeVotingSchedule> = Lazy::new(|| {
    ...
    let v1_datetime = ProtocolUpgradeVotingSchedule::parse_datetime("2024-07-09 17:00:00").unwrap();
    let v2_datetime = ProtocolUpgradeVotingSchedule::parse_datetime("2024-07-10 17:00:00").unwrap();
