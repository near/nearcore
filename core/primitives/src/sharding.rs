...
use crate::types::{Balance, BlockIndex, Gas, MerkleHash, ShardId, StateRootHash, ValidatorStake};
...
pub struct ShardChunkHeaderInner {
    ...
    pub prev_state_root: StateRootHash,
    pub prev_state_parts: u64,
