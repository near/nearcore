        ...
        System::builder()
            ...
            .run(move || {
                ...
                WaitOrTimeout::new(
                    Box::new(move |_ctx| {
                        actix::spawn(
                            test_nodes[0].client.send(Status { is_health_check: false }).then(
                                |res| {
                                    let res = res.unwrap();
                                    if res.is_err() {
                                        return future::ready(());
            ...
            .run(move || {
                ...
                WaitOrTimeout::new(
                    Box::new(move |_ctx| {
                        ...
                        actix::spawn(
                            test_node1.client.send(Status { is_health_check: false }).then(
                                move |res| {
