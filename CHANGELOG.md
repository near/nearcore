...
* Archival nodes with split storage (cold store) will run a one-time migration on startup that expected to take **1–2 hours** depending on disk performance. Expect downtime. Nodes without cold store are not affected. ([#15503](https://github.com/near/nearcore/pull/15503))
